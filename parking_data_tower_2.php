        ...
        ?>
            ...
            if($f1_row['status'] === "1"){
                ?><form action="" method="POST">
                    <button type="submit" name="submit" style="background:#0c0c7e;width:100%;height:170px;">
                    <i class="fa-solid fa-car" style="font-size:50px;color:white;"></i>
                    <p style="font-size:30px;color:lightgrey;"><span style="color:orange"><i class="fa-solid fa-square-parking"></i> <?php echo $f1_row['parking_number']; ?></span>     <i class="fa-solid fa-door-open"></i> <?php echo $f1_row['apt_id']; ?></p>
                    </button>
                </form>
                <?php
            }else{
            ?><form action="" method="POST">
                    <button type="submit" name="submit" style="background:green;width:100%;height:170px;">
                    <i class="fa-solid fa-car" style="font-size:50px;color:white;"></i>
                    <p style="font-size:30px;color:lightgrey;"><span style="color:orange"><i class="fa-solid fa-square-parking"></i> <?php echo $f1_row['parking_number']; ?></span>     <i class="fa-solid fa-door-closed"></i> <?php echo $f1_row['apt_id']; ?></p>
                    </button>
                </form>
                <?php
            }
