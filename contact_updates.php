...
$sql = "SELECT * FROM contact_update";
if (!empty($date)) {
    $date = $_POST['date'];
    $date = explode(" - ", $date);
    ...
    <table id="example" class="display nowrap" style="width:100%;text-align:center;">
        <thead>
            <tr>
                ...
                <th style="text-align:center !important;">Old EID</th>
                <th style="text-align:center !important;">Old Expiry</th>
                <th style="text-align:center !important;">Old File</th>
                <th style="text-align:center !important;">New Eid</th>
                <th style="text-align:center !important;">New Expiry</th>
                <th style="text-align:center !important;">New File</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row_transactions['email']; ?></td>
                <td><?php echo $row_transactions['old_eid_number']; ?></td>
                <td><?php echo $row_transactions['old_eid_date']; ?></td>
                <td><a href="attachments/<?php echo $row_transactions['old_file_name']; ?>" target=“blank”  style="font-weight:bold;font-weight: bold;background: #e30d0d;color: white;padding: 5px;border-radius: 5px;line-height: 3;"><i class="fa-solid fa-receipt"></i> View</a></td>
                <td><?php echo $row_transactions['new_eid_number']; ?></td>
                <td><?php echo $row_transactions['new_eid_date']; ?></td>
                <td><a href="attachments/<?php echo $row_transactions['new_file_name']; ?>" target=“blank”  style="font-weight:bold;font-weight: bold;background: #337ab7;color: white;padding: 5px;border-radius: 5px;line-height: 3;"><i class="fa-solid fa-receipt"></i> View</a></td>
