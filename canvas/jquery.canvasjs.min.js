...
*/
(function(){function na(h,m){h.prototype=cb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function cb(h){function m(){}m.prototype=h;return new m}function Wa(h,m,E){"millisecond"===E?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===E?h.setSeconds(h.getSeconds()+1*m):"minute"===E?h.setMinutes(h.getMinutes()+1*m):"hour"===E?h.setHours(h.getHours()+1*m):"day"===E?h.setDate(h.getDate()+1*m):"week"===E?h.setDate(h.getDate()+7*m):"month"===E?h.setMonth(h.getMonth()+1*m):"year"===E&&h.setFullYear(h.getFullYear()+
1*m);return h}function Z(h,m){var E=!1;0>h&&(E=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return E?"-"+h:h}function Fa(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,E=h.length;m.test(h.charAt(--E)););return h.slice(0,E+1)}function Ba(h){h.roundRect=function(h,E,r,w,S,A,v,B){v&&(this.fillStyle=v);B&&(this.strokeStyle=B);"undefined"===typeof S&&(S=5);this.lineWidth=A;this.beginPath();this.moveTo(h+S,E);this.lineTo(h+r-S,E);this.quadraticCurveTo(h+r,E,h+r,E+S);this.lineTo(h+r,E+w-S);
this.quadraticCurveTo(h+r,E+w,h+r-S,E+w);this.lineTo(h+S,E+w);this.quadraticCurveTo(h,E+w,h,E+w-S);this.lineTo(h,E+S);this.quadraticCurveTo(h,E,h+S,E);this.closePath();v&&this.fill();B&&0<A&&this.stroke()}}function Qa(h,m){return h-m}function P(h){var m=((h&16711680)>>16).toString(16),E=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;E=2>E.length?"0"+E:E;h=2>h.length?"0"+h:h;return"#"+m+E+h}function db(h,m){var E=this.length>>>0,r=Number(m)||0,r=0>r?Math.ceil(r):Math.floor(r);
for(0>r&&(r+=E);r<E;r++)if(r in this&&this[r]===h)return r;return-1}function r(h){return null===h||"undefined"===typeof h}function Ca(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(Ga.fSDec)h[W("`eeDwdouMhrudods")](W("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){Ga._fTWm&&Ga._fTWm(h)})}function Xa(h,m,E){E=E||"normal";var r=h+"_"+m+"_"+E,w=Ya[r];if(isNaN(w)){try{if(!oa){var S=document.body;oa=document.createElement("span");oa.innerHTML="";var A=document.createTextNode("Mpgyi");oa.appendChild(A);
S.appendChild(oa)}oa.style.display="";U(oa,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:E});w=Math.round(oa.offsetHeight);oa.style.display="none"}catch(v){w=Math.ceil(1.1*m)}w=Math.max(w,m);Ya[r]=w}return w}function J(h,m){var E=[];if(E={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var r=0;r<E.length;r++)E[r]*=m;else E=[];return E}function K(h,m,E,w,sa){w=w||[];sa=r(sa)?fb?{passive:!1,capture:!1}:!1:sa;w.push([h,m,E,sa]);return h.addEventListener?(h.addEventListener(m,E,sa),E):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};E.call(h,m)},h.attachEvent("on"+m,w),w):!1}function gb(h){if(h._menuButton)h.exportEnabled?
(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),La(h._menuButton),pa(h,h._menuButton,"menu")):ta(h._menuButton);else if(h.exportEnabled&&w){var m=!1;h._menuButton=document.createElement("button");pa(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);K(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);K(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||
(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);K(h._menuButton,"mousemove",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&U(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);K(h._menuButton,"mouseout",function(){m||(U(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&U(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){U(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var E=h._dropdownMenu.childNodes,r=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],sa=0;sa<E.length;sa++)U(E[sa],{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),E[sa].innerHTML=r[sa]}else!h._dropdownMenu&&(h.exportEnabled&&w)&&(m=!1,h._dropdownMenu=document.createElement("div"),h._dropdownMenu.setAttribute("tabindex",-1),E=-1!==h.theme.indexOf("dark")?"black":"#888888",U(h._dropdownMenu,{position:"absolute",zIndex:1,userSelect:"none",MozUserSeelct:"none",WebkitUserSelect:"none",msUserSelect:"none",cursor:"pointer",right:"0px",top:"25px",minWidth:"120px",outline:0,fontSize:"14px",fontFamily:"Arial, Helvetica, sans-serif",padding:"5px 0px 5px 0px",
textAlign:"left",lineHeight:"10px",backgroundColor:h.toolbar.itemBackgroundColor,boxShadow:"2px 2px 10px"+E}),h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),K(h._dropdownMenu,"blur",function(){ta(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),E=document.createElement("div"),U(E,{padding:"12px 8px 12px 8px"}),E.innerHTML=h._cultureInfo.printText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),
K(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),K(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),K(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),K(E,"click",function(){h.print();ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),E=document.createElement("div"),U(E,{padding:"12px 8px 12px 8px"}),
E.innerHTML=h._cultureInfo.saveJPGText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),K(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),K(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),K(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),K(E,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0),E=document.createElement("div"),U(E,{padding:"12px 8px 12px 8px"}),E.innerHTML=h._cultureInfo.savePNGText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),K(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),K(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),K(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),K(E,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ta(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Za(h,m,E){h*=ia;m*=ia;h=E.getImageData(h,m,2,2).data;m=!0;for(E=0;4>E;E++)if(h[E]!==h[E+4]|h[E]!==h[E+8]|h[E]!==h[E+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function la(h,m,E){return h in m?m[h]:E[h]}function Ma(h,m,E){if(w&&$a){var r=h.getContext("2d");Na=r.webkitBackingStorePixelRatio||r.mozBackingStorePixelRatio||r.msBackingStorePixelRatio||r.oBackingStorePixelRatio||r.backingStorePixelRatio||1;ia=Ra/Na;h.width=m*ia;h.height=E*ia;Ra!==Na&&(h.style.width=m+"px",h.style.height=E+"px",r.scale(ia,ia))}else h.width=m,h.height=E}function hb(h){if(!ib){var m=!1,E=!1;"undefined"===typeof ua.Chart.creditHref?(h.creditHref=W("iuuqr;..b`ow`rkr/bnl."),
h.creditText=W("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),E=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),U(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||m||E)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ra(h,m){Ha&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var E=document.createElement("canvas");E.setAttribute("class","canvasjs-chart-canvas");Ma(E,h,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(E);return E}function U(h,m){for(var E in m)h.style[E]=m[E]}function pa(h,m,E){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",U(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
E&&(m.setAttribute("state",E),m.setAttribute("type","button"),U(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.innerHTML="<img src='"+jb[E].image+"' alt='"+h._cultureInfo[E+"Text"]+"' />",U(m.childNodes[0],{height:"95%",pointerEvents:"none"}));m.setAttribute("title",h._cultureInfo[E+"Text"])}function La(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function ta(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Sa(h,m,E,r,w){if(null===h||"undefined"===typeof h)return"undefined"===typeof E?m:E;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof r&&(h=Math.min(r,h),"undefined"!==typeof w&&(h=Math.max(w,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof E?m:E}function X(h,m,E,w,v){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=v;this._eventListeners=[];
...
typeof v&&(v=0);this._padding=v;this._x1=h;this._y1=m;this._x2=r;this._y2=w;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ka(h,m){ka.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ta(h,m){Ta.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function wa(h,m){wa.base.constructor.call(this,
"Title","title",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(r(this.options.margin)&&h.options.subtitles)for(var E=h.options.subtitles,w=0;w<E.length;w++)if((r(E[w].horizontalAlign)&&"center"===this.horizontalAlign||E[w].horizontalAlign===this.horizontalAlign)&&(r(E[w].verticalAlign)&&"top"===this.verticalAlign||E[w].verticalAlign===this.verticalAlign)&&!E[w].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&
...
[]}function Ja(h){var m;h&&Ka[h]&&(m=Ka[h]);Ja.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ha=!1,Ga={},w=!!document.createElement("canvas").getContext,ua={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
Ka={en:{}},v=w?"Trebuchet MS, Helvetica, sans-serif":"Arial",Ea=w?"Impact, Charcoal, sans-serif":"Arial",xa={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
R,Y,V,da,ja;Y="#333333";V="#000000";R="#666666";ja=da="#000000";var ca=20,B=14,Va={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ea,fontSize:32,fontColor:Y,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:B,fontColor:Y,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:v,indexLabelFontSize:B,indexLabelFontColor:Y,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:Y,
...
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:Y,titleFontWeight:"normal",labelFontFamily:v,labelFontSize:B,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:R,tickThickness:1,tickColor:R,gridThickness:0,gridColor:R,stripLines:[{labelFontFamily:v,labelFontSize:B,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:v,
labelFontSize:B,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ja,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:Y,titleFontWeight:"normal",labelFontFamily:v,labelFontSize:B,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:R,tickThickness:1,tickColor:R,gridThickness:1,gridColor:R,stripLines:[{labelFontFamily:v,
labelFontSize:B,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:v,labelFontSize:B,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:ja,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:Y,titleFontWeight:"normal",labelFontFamily:v,labelFontSize:B,
...
lineDashType:"solid"}}],legend:{fontFamily:v,fontSize:14,fontColor:Y,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:v,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};V=Y="#F5F5F5";R="#FFFFFF";da="#40BAF1";ja="#F5F5F5";var ca=20,B=14,ab={colorSet:"colorSet2",title:{fontFamily:v,
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:v,labelFontSize:B,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:v,labelFontSize:B,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:v,labelFontSize:B,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:v,labelFontSize:B,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:v,labelFontSize:B,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:v,labelFontSize:B,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:v,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",
...
yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")},fb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(r){h=!1}return h}(),
Ya={},oa=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},va=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},lb=function(h,m,r){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},ya=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),r="Sun Mon Tue Wed Thu Fri Sat".split(" "),w="January February March April May June July August September October November December".split(" "),v="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),S=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,A=/[^-+\dA-Z]/g;return function(B,J,O){var R=O?O.days:m,P=O?O.months:w,K=O?O.shortDays:
r,I=O?O.shortMonths:v;O="";var U=!1;B=B&&B.getTime?B:B?new Date(B):new Date;if(isNaN(B))throw SyntaxError("invalid date");"UTC:"===J.slice(0,4)&&(J=J.slice(4),U=!0);O=U?"getUTC":"get";var X=B[O+"Date"](),N=B[O+"Day"](),$=B[O+"Month"](),a=B[O+"FullYear"](),d=B[O+"Hours"](),c=B[O+"Minutes"](),b=B[O+"Seconds"](),e=B[O+"Milliseconds"](),f=U?0:B.getTimezoneOffset();return O=J.replace(h,function(l){switch(l){case "D":return X;case "DD":return Z(X,2);case "DDD":return K[N];case "DDDD":return R[N];case "M":return $+
1;case "MM":return Z($+1,2);case "MMM":return I[$];case "MMMM":return P[$];case "Y":return parseInt(String(a).slice(-2));case "YY":return Z(String(a).slice(-2),2);case "YYY":return Z(String(a).slice(-3),3);case "YYYY":return Z(a,4);case "h":return d%12||12;case "hh":return Z(d%12||12,2);case "H":return d;case "HH":return Z(d,2);case "m":return c;case "mm":return Z(c,2);case "s":return b;case "ss":return Z(b,2);case "f":return Z(String(e),3).slice(0,1);case "ff":return Z(String(e),3).slice(0,2);case "fff":return Z(String(e),
3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return U?"UTC":(String(B).match(S)||[""]).pop().replace(A,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+Z(Math.floor(Math.abs(f)/60),2)+Z(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),mb=function(h){var m=0>h;if(1>Math.abs(h)){var r=
parseInt(h.toString().split("e-")[1]);r&&(h=(m?-1*h:h)*Math.pow(10,r-1),h="0."+Array(r).join("0")+h.toString().substring(2),h=m?"-"+h:h)}else r=parseInt(h.toString().split("+")[1]),20<r&&(r-=20,h/=Math.pow(10,r),h=h.toString()+Array(r+1).join("0"));return String(h)},ea=function(h,m,r){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var w=0>h?!0:!1;w&&(h*=-1);var v=r?r.decimalSeparator:".",S=r?r.digitGroupSeparator:",",A="";m=String(m);var A=1,B=r="",J=-1,O=[],R=[],P=0,K=0,I=0,U=!1,X=0,B=
m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var N=0;B&&N<B.length;N++)if(m=B[N],"."===m&&0>J)J=N;else{if("%"===m)A*=100;else if("\u2030"===m){A*=1E3;continue}else if(","===m[0]&&"."===m[m.length-1]){A/=Math.pow(1E3,m.length-1);J=N+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(U=!0);0>J?(O.push(m),"#"===m||"0"===m?P++:","===m&&I++):(R.push(m),"#"!==m&&"0"!==m||K++)}U&&(m=Math.floor(h),B=-Math.floor(Math.log(h)/Math.LN10+1),X=0===h?0:0===m?-(P+B):mb(m).length-
P,A/=Math.pow(10,X));0>J&&(J=N);A=(h*A).toFixed(K);m=A.split(".");A=(m[0]+"").split("");h=(m[1]+"").split("");A&&"0"===A[0]&&A.shift();for(U=B=N=K=J=0;0<O.length;)if(m=O.pop(),"#"===m||"0"===m)if(J++,J===P){var $=A,A=[];if("0"===m)for(m=P-K-($?$.length:0);0<m;)$.unshift("0"),m--;for(;0<$.length;)r=$.pop()+r,U++,0===U%B&&(N===I&&0<$.length)&&(r=S+r)}else 0<A.length?(r=A.pop()+r,K++,U++):"0"===m&&(r="0"+r,K++,U++),0===U%B&&(N===I&&0<A.length)&&(r=S+r);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||
!/[eE][+-]*[0]+/.test(m)?","===m?(N++,B=U,U=0,0<A.length&&(r=S+r)):r=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+r:m+r:(m=0>X?m.replace("+","").replace("-",""):m.replace("-",""),r+=m.replace(/[0]+/,function(a){return Z(X,a.length)}));S="";for(O=!1;0<R.length;)m=R.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(S+=h.shift(),O=!0):"0"===m&&(S+="0",O=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?
S+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?S+=m:(m=0>X?m.replace("+","").replace("-",""):m.replace("-",""),S+=m.replace(/[0]+/,function(a){return Z(X,a.length)}));r+=(O?v:"")+S;return w?"-"+r:r},Oa=function(h){var m=0,r=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,r=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,r=h.layerY):(m=h.pageX-h.target.offsetLeft,r=h.pageY-h.target.offsetTop);return{x:m,y:r}},$a=!0,Ra=window.devicePixelRatio||
1,Na=1,ia=$a?Ra/Na:1,ba=function(h,m,r,w,v,B,A,J,P,O,R,U,K){"undefined"===typeof K&&(K=1);A=A||0;J=J||"black";var I=15<w-m&&15<v-r?8:0.35*Math.min(w-m,v-r);h.beginPath();h.moveTo(m,r);h.save();h.fillStyle=B;h.globalAlpha=K;h.fillRect(m,r,w-m,v-r);h.globalAlpha=1;0<A&&(K=0===A%2?0:0.5,h.beginPath(),h.lineWidth=A,h.strokeStyle=J,h.moveTo(m,r),h.rect(m-K,r-K,w-m+2*K,v-r+2*K),h.stroke());h.restore();!0===P&&(h.save(),h.beginPath(),h.moveTo(m,r),h.lineTo(m+I,r+I),h.lineTo(w-I,r+I),h.lineTo(w,r),h.closePath(),
...
X.prototype.setOptions=function(h,m){if(ua[this._defaultsKey]){var r=ua[this._defaultsKey],w;for(w in r)"publicProperties"!==w&&r.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:r[w])}else Ha&&window.console&&console.log("defaults not set")};X.prototype.get=function(h){var m=ua[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};X.prototype.set=function(h,m,r){r="undefined"===typeof r?!0:r;var w=ua[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}r&&(this.stockChart||this.chart||this).render()};X.prototype.addTo=function(h,m,r,w){w="undefined"===typeof w?!0:w;var v=ua[this._defaultsKey];v.hasOwnProperty(h)||v.publicProperties&&v.publicProperties.hasOwnProperty(h)&&"readWrite"===v.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
...
m=r):m=void 0,h[m]=this.options};X.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Ca(m);var r=m.indexOf(this.options);0<=r&&m.splice(r,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};X.prototype.updateOption=function(h){!ua[this._defaultsKey]&&(Ha&&window.console)&&console.log("defaults not set");var m=ua[this._defaultsKey],w={},v=this[h],B=this._themeOptionsKey,
S=this._index;this.theme&&r(this.parent)&&r(B)&&r(S)?w=r(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[B])&&(null===S?w=this.parent.themeOptions[B]:0<this.parent.themeOptions[B].length&&(w=Math.min(this.parent.themeOptions[B].length-1,S),w=this.parent.themeOptions[B][w]));this.themeOptions=w;h in m&&(v=h in this.options?this.options[h]:w&&h in w?w[h]:m[h]);if(v===this[h])return!1;this[h]=
...
if(r<m)w=B+1;else if(r>m)v=B-1;else break}r>m&&1<A.length&&(A=A.substr(0,A.length-1),r=this.ctx.measureText(A).width);m=!0;if(A.length===h.length||" "===h[A.length])m=!1;m&&(h=A.split(" "),1<h.length&&h.pop(),A=h.join(" "),r=this.ctx.measureText(A).width);return{text:A,width:r}};ka.prototype._wrapText=function(){var h=new String(Fa(String(this.text))),m=[],r=this.ctx.font,w=0,v=0;this.ctx.font=this._getFontString();if(0===this.frontSize)v=w=0;else for(;0<h.length;){var B=this.maxHeight-(this.topPadding+
this.bottomPadding),A=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);A.height=this._lineHeight;m.push(A);var J=v,v=Math.max(v,A.width),w=w+A.height,h=Fa(h.slice(A.text.length,h.length));B&&w>B&&(A=m.pop(),w-=A.height,v=J)}this._wrappedText={lines:m,width:v,height:w};this.width=v+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=r};ka.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};na(Ta,X);na(wa,X);wa.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,v=m.y1,B=0,J=0,A=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,I,K;"top"===this.verticalAlign||
...
this.height=O.height),I="center");J.x=w;J.y=v;J.angle=B;J.horizontalAlign=I;this._textBlock=J;h.layoutManager.registerSpace(K,{width:this.width+("left"===K||"right"===K?this.margin+2:0),height:this.height+("top"===K||"bottom"===K?this.margin+2:0)});this.bounds={x1:w,y1:v,x2:w+this.width,y2:v+this.height};this.ctx.textBaseline="top"}};wa.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};na(Ia,X);Ia.prototype.setLayout=wa.prototype.setLayout;Ia.prototype.render=wa.prototype.render;
Ua.prototype.get=function(h,m){var r=null;0<this.pool.length?(r=this.pool.pop(),Ma(r,h,m)):r=ra(h,m);return r};Ua.prototype.release=function(h){this.pool.push(h)};na(Ja,X);var Pa={addTheme:function(h,m){bb[h]=m},addColorSet:function(h,m){xa[h]=m},addCultureInfo:function(h,m){Ka[h]=m},formatNumber:function(h,m,r){r=r||"en";if(Ka[r])return ea(h,m||"#,##0.##",new Ja(r));throw"Unknown Culture Name";},formatDate:function(h,r,w){w=w||"en";if(Ka[w])return ya(h,r||"DD MMM YYYY",new Ja(w));throw"Unknown Culture Name";
...
this.overlaidCanvasCtx.textBaseline="top",Ba(this.overlaidCanvasCtx)),this._eventManager=new da(this),this.windowResizeHandler=K(window,"resize",function(){b._updateSize()&&b.render()},this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),U(this._toolBar,{position:"absolute",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},K(this.overlaidCanvas,
"click",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mousemove",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mouseup",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mousedown",function(a){b._mouseEventHandler(a);ta(b._dropdownMenu)},this.allDOMEventHandlers),K(this.overlaidCanvas,"mouseout",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),K(this.overlaidCanvas,window.navigator.msPointerEnabled?
...
(l.color=f,t.color=f):k=1;n=D?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);D?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(J(t.dashType,t.thickness));a.beginPath();D&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):
0<t.thickness&&(a.moveTo(Math.round((d+b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();D&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function R(a,d){R.base.constructor.call(this,"Legend","legend",d,null,
...
this.options.scaleBreaks,++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new O(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new Y(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=
...
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function da(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ra(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ja(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
this.animations=[];this.animationRequestId=null}na(m,X);m.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();this._panTimerId&&clearTimeout(this._panTimerId);for(var d=0;d<a.length;d++){var c=a[d][0],b=a[d][1],e=a[d][2],f=a[d][3],f=f||!1;c.removeEventListener?c.removeEventListener(b,e,f):c.detachEvent&&c.detachEvent("on"+b,e)}this.allDOMEventHandlers=[];for(this.removeAllEventListeners();this._canvasJSContainer&&this._canvasJSContainer.hasChildNodes();)this._canvasJSContainer.removeChild(this._canvasJSContainer.lastChild);
for(;this.container&&this.container.hasChildNodes();)this.container.removeChild(this.container.lastChild);for(;this._dropdownMenu&&this._dropdownMenu.hasChildNodes();)this._dropdownMenu.removeChild(this._dropdownMenu.lastChild);this.container=this._canvasJSContainer=null;this.toolTip.container=null;this.canvas&&va(this.canvas);this.overlaidCanvas&&va(this.overlaidCanvas);this._preRenderCanvas&&va(this._preRenderCanvas);this._breaksCanvas&&va(this._breaksCanvas);this._eventManager&&this._eventManager.ghostCanvas&&
va(this._eventManager.ghostCanvas);this._toolBar=this._dropdownMenu=this._menuButton=this._resetButton=this._zoomButton=null};m.prototype._updateOptions=function(){var a=this;this.updateOption("width");this.updateOption("height");this.updateOption("dataPointWidth");this.updateOption("dataPointMinWidth");this.updateOption("dataPointMaxWidth");this.updateOption("interactivityEnabled");this.updateOption("theme");this.updateOption("colorSet")&&(this.selectedColorSet="undefined"!==typeof xa[this.colorSet]?
xa[this.colorSet]:xa.colorSet1);this.updateOption("backgroundColor");this.backgroundColor||(this.backgroundColor="rgba(0,0,0,0)");this.updateOption("culture");this._cultureInfo=new Ja(this.options.culture);this.updateOption("animationEnabled");this.animationEnabled=this.animationEnabled&&w;this.updateOption("animationDuration");this.updateOption("rangeChanging");this.updateOption("rangeChanged");this.updateOption("exportEnabled");this.updateOption("exportFileName");this.updateOption("zoomType");this.toolbar=
...
"px solid "+this.toolbar.buttonBorderColor;K(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);K(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,pa(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,pa(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);K(this._zoomButton,"mousemove",function(){d?d=!1:(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",
WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);K(this._zoomButton,"mouseout",function(){d||(U(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers)}this._resetButton?
...
a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,a.stockChart));a.render();a.syncCharts&&a.syncCharts(null,null);a._dispatchRangeEvent("rangeChanged","reset");a.stockChart&&(a.stockChart._rangeEventParameter.type="rangeChanged",a.stockChart.dispatchEvent("rangeChanged",a.stockChart._rangeEventParameter,a.stockChart))},this.allDOMEventHandlers),K(this._resetButton,"mousemove",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,
transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),K(this._resetButton,"mouseout",function(){d||(U(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&U(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),
this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),La(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=!1;gb(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?pa(a,a._zoomButton,"zoom"):pa(a,a._zoomButton,"pan"),
...
this._eventManager.reset();this.plotInfo={axisPlacement:null,plotTypes:[]};this.layoutManager=new Da(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new S(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);
...
this.options.title&&(this.title=new wa(this,this.options.title),this.title.dockInsidePlotArea?a.push(this.title):this.title.setLayout());if(this.options.subtitles)for(d=0;d<this.options.subtitles.length;d++)c=new Ia(this,this.options.subtitles[d],d),this.subtitles.push(c),c.dockInsidePlotArea?a.push(c):c.setLayout();this.legend=new R(this,this.options.legend);for(d=0;d<this.data.length;d++)(this.data[d].showInLegend||"pie"===this.data[d].type||"doughnut"===this.data[d].type||"funnel"===this.data[d].type||
...
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&s<b&&(c.viewPortMin=s):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),D[b]=D[b]?D[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=r(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=
...
!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,t=!1,D=0;D<a.dataSeriesIndexes.length;D++){var k=this.data[a.dataSeriesIndexes[D]],n=0,p=!1,q=!1,g,s,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:
...
(t=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);s=!0;for(var r=0;r<e.length;r++)null===e.k&&(s=!1);s&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(s=b/k.dataPoints[n-1].x,1>s&&(s=1/s),c.minDiff>s&&1!==s&&(c.minDiff=s)):(s=b-k.dataPoints[n-1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==
k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(s=e[0]/k.dataPoints[n-1].y[0],1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e[0]-k.dataPoints[n-1].y[0],0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(r=0;r<e.length;r++)if(null===e[r]&&g<b){c.viewPortMin=
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(La(this._zoomButton,this._resetButton),pa(this,this._zoomButton,"pan"),pa(this,this._resetButton,
...
b=0,e=0,f=0,l=f=e=0,t=0,D=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=la("indexLabelFontColor",n.dataPoint,n.dataSeries),s=la("indexLabelFontSize",n.dataPoint,n.dataSeries),t=la("indexLabelFontFamily",n.dataPoint,n.dataSeries),D=la("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=la("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=la("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=la("indexLabelWrap",n.dataPoint,n.dataSeries);var m=la("indexLabelLineDashType",n.dataPoint,n.dataSeries),u=la("indexLabelLineColor",n.dataPoint,n.dataSeries),y=r(n.dataPoint.indexLabelLineThickness)?r(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,x={percent:null,total:null},z=null;if(0<=n.dataSeries.type.indexOf("stacked")||
...
n.dataSeries.indexLabelFormatter(z):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==G&&""!==G){var x=la("indexLabelPlacement",n.dataPoint,n.dataSeries),z=la("indexLabelOrientation",n.dataPoint,n.dataSeries),C=la("indexLabelTextAlign",n.dataPoint,n.dataSeries),v=n.direction,e=n.dataSeries.axisX,f=n.dataSeries.axisY,A=!1,h=new ka(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*s:1.5*s,angle:"horizontal"===
z?0:-90,text:G,padding:0,backgroundColor:h,textAlign:C,fontSize:s,fontFamily:t,fontWeight:k,fontColor:l,fontStyle:D,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>
...
n.point.y<c.y2||!A))&&(d.lineWidth=y,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(J(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:D+l)+("vertical"===z?-s/2:0),g+("vertical"===z?-k/2:k/2-s/2)-t):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+D/2-("horizontal"===z?0:s/2),g+("vertical"===z?(g-k<n.point.y?0:-k)+t:(g-s/2<n.point.y?k:0)-s/2)):d.lineTo(q+D/2-("horizontal"===z?0:s/2),g+("vertical"===
z?g-k<n.point.y?0:-k:(g-s/2<n.point.y?k:0)-s/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:N.fadeInAnimation,easingFunction:N.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=la("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=r(h)?w?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
dataSeriesIndex:D};s=P(s);b.strokeStyle=s;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];c.strokeStyle=s;var m=!0,u=0,r,x;c.beginPath();if(0<n.length){for(var z=!1,u=0;u<n.length;u++)if(r=n[u].x.getTime?n[u].x.getTime():n[u].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[u].y)0<u&&!(k.connectNullData||z||m)&&(c.stroke(),w&&b.stroke()),z=
...
b.moveTo(r,x))),z=m=!1):(c.lineTo(r,x),w&&b.lineTo(r,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(r,x),w&&(b.stroke(),b.beginPath(),b.moveTo(r,x))));l={x:r,y:x};u<n.length-1&&(h!==(n[u].lineColor||s)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(r,x),h=n[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize){var C=k.getMarkerProperties(u,
r,x,c);f.push(C);G=P(G);w&&f.push({x:r,y:x,ctx:b,type:C.type,size:C.size,color:G,borderColor:G,borderThickness:C.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:r,y:x},direction:0>n[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();w&&b.stroke()}}$.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=P(s);b.strokeStyle=s;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var s=k._colorSet,h=s=k.lineColor=k.options.lineColor?k.options.lineColor:s[0];c.strokeStyle=s;var m=!0,u=0,r,x;c.beginPath();if(0<n.length){for(var z=!1,u=0;u<n.length;u++)if(r=n[u].getTime?n[u].x.getTime():n[u].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[u].y)0<
...
c.lineTo(r,G),c.lineTo(r,x),w&&(b.lineTo(r,G),b.lineTo(r,x))):(c.beginPath(),c.moveTo(r,x),w&&(b.beginPath(),b.moveTo(r,x))),z=m=!1):(c.lineTo(r,G),w&&b.lineTo(r,G),c.lineTo(r,x),w&&b.lineTo(r,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(r,x),w&&(b.stroke(),b.beginPath(),b.moveTo(r,x))));l={x:r,y:x};u<n.length-1&&(h!==(n[u].lineColor||s)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(r,x),h=n[u].lineColor||s,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,
c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize)G=k.getMarkerProperties(u,r,x,c),f.push(G),C=P(C),w&&f.push({x:r,y:x,ctx:b,type:G.type,size:G.size,color:C,borderColor:C,borderThickness:G.borderThickness});(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:r,y:x},direction:0>n[u].y===a.axisY.reversed?1:-1,color:s})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var D=a.dataSeriesIndexes[t],k=this.data[D];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var s=k.id;this._eventManager.objectMap[s]={objectType:"dataSeries",dataSeriesIndex:D};s=P(s);e.strokeStyle=s;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
...
x[x.length-1].newLineDashArray=g)));if(0<n[r].markerSize||0<k.markerSize){var G=k.getMarkerProperties(r,u,m,b);l.push(G);z=P(z);w&&l.push({x:u,y:m,ctx:e,type:G.type,size:G.size,color:z,borderColor:z,borderThickness:G.borderThickness})}(n[r].indexLabel||k.indexLabel||n[r].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[r],dataSeries:k,point:{x:u,y:m},direction:0>n[r].y===a.axisY.reversed?1:-1,color:s});m=!1}d(x)}$.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
D=s[f].x,!(D<a.axisX.dataInfo.viewPortMin||D>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[f].y){l=a.axisX.convertValueToPixel(D);t=a.axisY.convertValueToPixel(s[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var r=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=s[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=s[f].color?s[f].color:g._colorSet[f%g._colorSet.length];ba(c,a.axisX.reversed?r:l,t,a.axisX.reversed?
l:r,u,b,0,null,h&&(a.axisY.reversed?0>s[f].y:0<=s[f].y),(a.axisY.reversed?0<=s[f].y:0>s[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:r,y2:u};b=P(b);w&&ba(this._eventManager.ghostCtx,a.axisX.reversed?r:l,t,a.axisX.reversed?l:r,u,b,0,null,!1,!1,!1,!1);(s[f].indexLabel||g.indexLabel||s[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:s[f],
...
l[b]?l[b]:0,z=p+G,p=q+G,l[b]=G+(z-p);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];ba(c,n,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,m&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&m,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:x,y2:z};b=P(b);w&&ba(this._eventManager.ghostCtx,n,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||
...
else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var G="undefined"!==typeof f[b]?f[b]:0;p-=G;z=q-G;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=G+(z-p)}else G="undefined"!==typeof l[b]?l[b]:0,z=p+G,p=q+G,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=G+(z-p);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];ba(c,n,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,m&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&
m,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:x,y2:z};b=P(b);w&&ba(this._eventManager.ghostCtx,n,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:r,point:{x:n+(x-n)/2,y:0<=u[k].y?p:z},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:n,y1:Math.min(p,z),
...
n)*p<<0;var r=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=s[f].y?u=k:(u=l,l=k);b=s[f].color?s[f].color:g._colorSet[f%g._colorSet.length];ba(c,a.axisY.reversed?l:u,a.axisX.reversed?r:t,a.axisY.reversed?u:l,a.axisX.reversed?t:r,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:r};b=P(b);w&&ba(this._eventManager.ghostCtx,u,a.axisX.reversed?r:t,l,a.axisX.reversed?t:r,b,0,null,!1,!1,!1,!1);(s[f].indexLabel||
...
p=p-a.plotType.plotUnits.length*s/2+a.index*s<<0;var x=p+s<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(z=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=u[k].y+(D[b]?D[b]:0),n=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(D[b]);else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var G=f[b]?f[b]:0;z=q+G;n+=
G;f[b]=G+(n-z)}else G=l[b]?l[b]:0,z=n-G,n=q-G,l[b]=G+(n-z);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];ba(c,a.axisY.reversed?n:z,p,a.axisY.reversed?z:n,x,b,0,null,m,!1,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:n,y2:x};b=P(b);w&&ba(this._eventManager.ghostCtx,z,p,n,x,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||r.indexLabel||u[k].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
...
s/2+a.index*s<<0;var z=p+s<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=x+(t[b]?t[b]:0);if(0>=t[b])continue;x=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)D[b]=x+(D[b]?D[b]:0),n=l[b]?l[b]:q,l[b]=x=a.axisY.convertValueToPixel(D[b]);else if(n=a.axisY.convertValueToPixel(x),0<=u[k].y){var G=f[b]?f[b]:0;x=q+G;n+=G;a.dataSeriesIndexes.length-1===g&&
1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=G+(n-x)}else G=l[b]?l[b]:0,x=n-G,n=q-G,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x1-x)&&(x=e.x1),l[b]=G+(n-x);b=u[k].color?u[k].color:r._colorSet[k%r._colorSet.length];ba(c,a.axisY.reversed?n:x,p,a.axisY.reversed?x:n,z,b,0,null,m,!1,!1,!1,r.fillOpacity);b=r.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:p,x2:n,y2:z};b=P(b);w&&ba(this._eventManager.ghostCtx,x,p,n,z,b,0,null,!1,!1,!1,!1);
...
c;function b(){G&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(r,z),f.lineTo(G.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(r,z),l.lineTo(G.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(r,u),l.beginPath(),l.moveTo(r,u),G={x:r,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=
this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,D=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints,D=g.id;this._eventManager.objectMap[D]={objectType:"dataSeries",dataSeriesIndex:q};D=P(D);l.fillStyle=D;D=[];d=!0;var h=0,r,u,m,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),z,G=null;if(0<s.length){var C=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var M=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var T=J(c,g.lineThickness);f.setLineDash(T)}for(var ga=!0;h<s.length;h++)if(m=s[h].x.getTime?s[h].x.getTime():s[h].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ga)))if("number"!==
typeof s[h].y)g.connectNullData||(ga||d)||b(),ga=!0;else{r=a.axisX.convertValueToPixel(m);u=a.axisY.convertValueToPixel(s[h].y);d||ga?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=r,c=u,r=n.x,u=n.y,b(),f.moveTo(n.x,n.y),r=d,u=c,G=n,c=g.nullDataLineDashType,f.setLineDash(M)),f.lineTo(r,u),w&&l.lineTo(r,u)):(f.beginPath(),f.moveTo(r,u),w&&(l.beginPath(),l.moveTo(r,u)),G={x:r,y:u}),ga=d=!1):(f.lineTo(r,u),w&&l.lineTo(r,
u),0==h%250&&b());n={x:r,y:u};h<s.length-1&&(A!==(s[h].lineColor||v)||c!==(s[h].lineDashType||g.lineDashType))&&(b(),A=s[h].lineColor||v,f.strokeStyle=A,f.setLineDash&&(s[h].lineDashType?(c=s[h].lineDashType,f.setLineDash(J(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(T))));var aa=g.dataPointIds[h];this._eventManager.objectMap[aa]={id:aa,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:r,y1:u};0!==s[h].markerSize&&(0<s[h].markerSize||0<g.markerSize)&&(m=g.getMarkerProperties(h,
r,u,f),D.push(m),aa=P(aa),w&&D.push({x:r,y:u,ctx:l,type:m.type,size:m.size,color:aa,borderColor:aa,borderThickness:m.borderThickness}));(s[h].indexLabel||g.indexLabel||s[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:s[h],dataSeries:g,point:{x:r,y:u},direction:0>s[h].y===a.axisY.reversed?1:-1,color:C})}b();$.drawMarkers(D)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
...
y:c[0].y};b.lineTo(c[c.length-1].x,m);b.lineTo(u.x,m);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,m),e.lineTo(u.x,m),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,
t.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=P(l);e.fillStyle=l;var l=[],q=0,g,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,u=null,y=[];if(0<p.length){var x=n._colorSet[q%n._colorSet.length],z=n.lineColor=n.options.lineColor||x,G=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=n.lineThickness;var C="solid";
if(b.setLineDash){var A=J(n.nullDataLineDashType,n.lineThickness),C=n.lineDashType,B=J(C,n.lineThickness);b.setLineDash(B)}for(s=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!s)))if("number"!==typeof p[q].y)0<q&&!s&&(n.connectNullData?b.setLineDash&&(0<y.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,C=n.nullDataLineDashType):(d(),y=[])),s=!0;
else{g=a.axisX.convertValueToPixel(g);s=a.axisY.convertValueToPixel(p[q].y);var M=n.dataPointIds[q];this._eventManager.objectMap[M]={id:M,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:s};y[y.length]={x:g,y:s};q<p.length-1&&(G!==(p[q].lineColor||z)||C!==(p[q].lineDashType||n.lineDashType))&&(G=p[q].lineColor||z,y[y.length-1].newStrokeStyle=G,b.setLineDash&&(p[q].lineDashType?(C=p[q].lineDashType,y[y.length-1].newLineDashArray=J(C,n.lineThickness)):(C=n.lineDashType,y[y.length-1].newLineDashArray=
B)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var T=n.getMarkerProperties(q,g,s,b);l.push(T);M=P(M);w&&l.push({x:g,y:s,ctx:e,type:T.type,size:T.size,color:M,borderColor:M,borderThickness:T.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:s},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x});s=!1}d();$.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:N.xClipAnimation,easingFunction:N.easing.linear,
animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){G&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(m,z),f.lineTo(G.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,z),l.lineTo(G.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,u),l.beginPath(),l.moveTo(m,u),G={x:m,y:u})}var e=a.targetCanvasCtx||
this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,h=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=P(h);l.fillStyle=
h;h=[];d=!0;var r=0,m,u,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),z,G=null;c=!1;if(0<s.length){var C=g._colorSet[r%g._colorSet.length],v=g.lineColor=g.options.lineColor||C,A=v;f.fillStyle=C;f.strokeStyle=v;f.lineWidth=g.lineThickness;var M="solid";if(f.setLineDash){var T=J(g.nullDataLineDashType,g.lineThickness),M=g.lineDashType,E=J(M,g.lineThickness);f.setLineDash(E)}for(;r<s.length;r++)if(y=s[r].x.getTime?s[r].x.getTime():s[r].x,!(y<a.axisX.dataInfo.viewPortMin||
y>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var aa=u;"number"!==typeof s[r].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(y),u=a.axisY.convertValueToPixel(s[r].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||M===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,G=n,M=g.nullDataLineDashType,f.setLineDash(T)),f.lineTo(m,aa),f.lineTo(m,u),w&&(l.lineTo(m,aa),l.lineTo(m,u))):
(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),G={x:m,y:u}),c=d=!1):(f.lineTo(m,aa),w&&l.lineTo(m,aa),f.lineTo(m,u),w&&l.lineTo(m,u),0==r%250&&b()),n={x:m,y:u},r<s.length-1&&(A!==(s[r].lineColor||v)||M!==(s[r].lineDashType||g.lineDashType))&&(b(),A=s[r].lineColor||v,f.strokeStyle=A,f.setLineDash&&(s[r].lineDashType?(M=s[r].lineDashType,f.setLineDash(J(M,g.lineThickness))):(M=g.lineDashType,f.setLineDash(E)))),y=g.dataPointIds[r],this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:r,x1:m,y1:u},0!==s[r].markerSize&&(0<s[r].markerSize||0<g.markerSize)&&(aa=g.getMarkerProperties(r,m,u,f),h.push(aa),y=P(y),w&&h.push({x:m,y:u,ctx:l,type:aa.type,size:aa.size,color:y,borderColor:y,borderThickness:aa.borderThickness})),(s[r].indexLabel||g.indexLabel||s[r].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:s[r],dataSeries:g,point:{x:m,y:u},direction:0>s[r].y===a.axisY.reversed?1:-1,color:C}))}b();$.drawMarkers(h)}}w&&
...
k=[],n=[],p=[],q=0,g,s,r=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m=this._eventManager.ghostCtx,u,y,x;w&&m.beginPath();b.save();w&&m.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(m.beginPath(),m.rect(t.x1,t.y1,t.width,t.height),m.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var G=a.dataSeriesIndexes[z],C=this.data[G],v=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<v.length;q++)G=v[q].x.getTime?v[q].x.getTime():v[q].x,C.dataPointIndexes[G]=
q,e[G]||(n.push(G),e[G]=!0);n.sort(Qa)}for(z=0;z<a.dataSeriesIndexes.length;z++){G=a.dataSeriesIndexes[z];C=this.data[G];v=C.dataPoints;y=!0;k=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:G};q=P(q);m.fillStyle=q;if(0<n.length){var e=C._colorSet[0],A=C.lineColor=C.options.lineColor||e,M=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=C.lineThickness;x="solid";if(b.setLineDash){var T=J(C.nullDataLineDashType,C.lineThickness);x=C.lineDashType;var E=J(x,C.lineThickness);
b.setLineDash(E)}for(var aa=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=C.dataPointIndexes[f]?v[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!aa)))if("number"!==typeof ha.y)C.connectNullData||(aa||y)||d(),aa=!0;else{g=a.axisX.convertValueToPixel(f);var ma=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ha.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;
s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(ha.y),s-=ma;k.push({x:g,y:r-ma});h[f]=r-s;y||aa?(!y&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||x===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(x),k.push(y),x=C.nullDataLineDashType,b.setLineDash(T)),b.lineTo(g,s),w&&m.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(m.beginPath(),m.moveTo(g,s))),aa=y=!1):(b.lineTo(g,s),w&&m.lineTo(g,s),
0==q%250&&(d(),b.moveTo(g,s),w&&m.moveTo(g,s),k.push({x:g,y:r-ma})));u={x:g,y:s};q<v.length-1&&(M!==(v[q].lineColor||A)||x!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,s),k.push({x:g,y:r-ma}),M=v[q].lineColor||A,b.strokeStyle=M,b.setLineDash&&(v[q].lineDashType?(x=v[q].lineDashType,b.setLineDash(J(x,C.lineThickness))):(x=C.lineDashType,b.setLineDash(E))));if(0<=C.dataPointIndexes[f]){var B=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",
dataSeriesIndex:G,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:s}}0<=C.dataPointIndexes[f]&&0!==ha.markerSize&&(0<ha.markerSize||0<C.markerSize)&&(ma=C.getMarkerProperties(C.dataPointIndexes[f],g,s,b),l.push(ma),f=P(B),w&&l.push({x:g,y:s,ctx:m,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(ha.indexLabel||C.indexLabel||ha.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ha,dataSeries:C,point:{x:g,y:s},direction:0>
v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,s);w&&m.moveTo(g,s)}delete C.dataPointIndexes}$.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,
t.y1,t.width,t.height),m.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:N.xClipAnimation,easingFunction:N.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&x.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(x.closePath(),x.fill(),x.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,
...
if(b.setLineDash){var T=J(C.nullDataLineDashType,C.lineThickness);u=C.lineDashType;var E=J(u,C.lineThickness);b.setLineDash(E)}for(var aa=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=C.dataPointIndexes[f]?v[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!aa)))if("number"!==typeof ha.y)C.connectNullData||(aa||m)||d(),aa=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(ha.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);
var B=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ma+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;s=a.axisY.convertValueToPixel(p[f])}else s=a.axisY.convertValueToPixel(ma),s-=B;k.push({x:g,y:y-B});h[f]=y-s;m||aa?(!m&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||u===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(m=k.pop(),u=k[k.length-1],d(),b.moveTo(r.x,r.y),k.push(u),k.push(m),u=C.nullDataLineDashType,
b.setLineDash(T)),b.lineTo(g,s),w&&x.lineTo(g,s)):(b.beginPath(),b.moveTo(g,s),w&&(x.beginPath(),x.moveTo(g,s))),aa=m=!1):(b.lineTo(g,s),w&&x.lineTo(g,s),0==q%250&&(d(),b.moveTo(g,s),w&&x.moveTo(g,s),k.push({x:g,y:y-B})));r={x:g,y:s};q<v.length-1&&(M!==(v[q].lineColor||A)||u!==(v[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,s),k.push({x:g,y:y-B}),M=v[q].lineColor||A,b.strokeStyle=M,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(J(u,C.lineThickness))):(u=C.lineDashType,
b.setLineDash(E))));if(0<=C.dataPointIndexes[f]){var F=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:G,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:s}}0<=C.dataPointIndexes[f]&&0!==ha.markerSize&&(0<ha.markerSize||0<C.markerSize)&&(B=C.getMarkerProperties(q,g,s,b),t.push(B),f=P(F),w&&t.push({x:g,y:s,ctx:x,type:B.type,size:B.size,color:f,borderColor:f,borderThickness:B.borderThickness}));(ha.indexLabel||C.indexLabel||ha.indexLabelFormatter||
...
t&&(t=g),g<h&&(h=g));for(var s=25*Math.PI,r=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,s),k=0;k<a.dataSeriesIndexes.length;k++)if(n=a.dataSeriesIndexes[k],p=this.data[n],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);var g=q[e].z,m=2*Math.max(Math.sqrt((t===
h?r/2:s+(r-s)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=m;c.globalAlpha=p.fillOpacity;$.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:m};m=P(u);w&&$.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,m,m,g.borderThickness);(q[e].indexLabel||p.indexLabel||q[e].indexLabelFormatter||p.indexLabelFormatter)&&
...
b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints;if(0<n.length){c.strokeStyle="#4572A7 ";Math.pow(0.3*Math.min(b.height,b.width)/2,2);for(var p=0,q=0,e=0;e<n.length;e++)if(f=n[e].getTime?f=n[e].x.getTime():f=n[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof n[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(n[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;$.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=P(p),w&&
$.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||n[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),p=f,q=l)}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>f&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<e)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<e&&(s=e);s>f&&(s=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=
0;m<a.dataSeriesIndexes.length;m++){var fa=a.dataSeriesIndexes[m],u=this.data[fa],y=u.dataPoints;if(0<y.length)for(var x=5<s&&u.bevelEnabled?!0:!1,t=0;t<y.length;t++)if(y[t].getTime?g=y[t].x.getTime():g=y[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(y[t].y)&&y[t].y.length&&"number"===typeof y[t].y[0]&&"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);n=a.axisY.convertValueToPixel(y[t].y[1]);
p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);var z=h-s/2<<0,G=z+s<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],C=Math.round(Math.max(1,0.15*s)),v=0===C%2?0:0.5,A=u.dataPointIds[t];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:fa,dataPointIndex:t,x1:z,y1:k,x2:G,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:C,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=C;b.lineWidth=Math.max(C,4);
"candlestick"===u.type?(c.moveTo(h-v,n),c.lineTo(h-v,Math.min(k,q)),c.stroke(),c.moveTo(h-v,Math.max(k,q)),c.lineTo(h-v,p),c.stroke(),ba(c,z,Math.min(k,q),G,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,C,e,x,x,!1,!1,u.fillOpacity),w&&(e=P(A),b.strokeStyle=e,b.moveTo(h-v,n),b.lineTo(h-v,Math.min(k,q)),b.stroke(),b.moveTo(h-v,Math.max(k,q)),b.lineTo(h-v,p),b.stroke(),ba(b,z,Math.min(k,q),G,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-v,n),c.lineTo(h-v,p),c.stroke(),c.beginPath(),
c.moveTo(h,k),c.lineTo(z,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(G,q),c.stroke(),w&&(e=P(A),b.strokeStyle=e,b.moveTo(h-v,n),b.lineTo(h-v,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(z,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(G,q),b.stroke()));(y[t].indexLabel||u.indexLabel||y[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[t],dataSeries:u,point:{x:z+(G-z)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:z,y1:Math.min(n,
...
this.dataPointWidth:0.015*this.width,s=a.axisX.dataInfo.minDiff;isFinite(s)||(s=0.3*Math.abs(a.axisX.range));s=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(s)/Math.log(a.axisX.range):Math.abs(s)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));s<
e&&(s=e);s>l&&(s=l);c.save();w&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,fa=0;fa<a.dataSeriesIndexes.length;fa++){var u=a.dataSeriesIndexes[fa],y=this.data[u],x=y.dataPoints;if(0<x.length)for(var z=5<s&&y.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?g=x[l].x.getTime():g=x[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(x[l].y)&&x[l].y.length&&
"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]&&"number"===typeof x[l].y[4]&&5===x[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[l].y[0]);k=a.axisY.convertValueToPixel(x[l].y[1]);n=a.axisY.convertValueToPixel(x[l].y[2]);p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var v=t-s/2<<0,C=t+s/2<<0,e=x[l].color?x[l].color:y._colorSet[0],A=Math.round(Math.max(1,0.15*s)),E=
0===A%2?0:0.5,M=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?y.whiskerColor:e,T="number"===typeof x[l].whiskerThickness?x[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:A,B=x[l].whiskerDashType?x[l].whiskerDashType:y.whiskerDashType,aa=r(x[l].whiskerLength)?r(y.options.whiskerLength)?s:y.whiskerLength:x[l].whiskerLength,aa="number"===typeof aa?0>=aa?0:aa>=s?s:aa:"string"===typeof aa?parseInt(aa)*s/100>s?
s:parseInt(aa)*s/100:s,ha=1===Math.round(T)%2?0.5:0,ma=x[l].stemColor?x[l].stemColor:x[l].color?y.stemColor?y.stemColor:x[l].color:y.stemColor?y.stemColor:e,za="number"===typeof x[l].stemThickness?x[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:A,F=1===Math.round(za)%2?0.5:0,I=x[l].stemDashType?x[l].stemDashType:y.stemDashType,K=x[l].lineColor?x[l].lineColor:x[l].color?y.lineColor?y.lineColor:x[l].color:y.lineColor?y.lineColor:e,O="number"===typeof x[l].lineThickness?
x[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:A,R=x[l].lineDashType?x[l].lineDashType:y.lineDashType,L=1===Math.round(O)%2?0.5:0,S=y.upperBoxColor,U=y.lowerBoxColor,qa=r(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:v,y1:h,x2:C,y2:k,x3:t,y3:n,x4:t,y4:p,y5:q,borderThickness:A,color:e,stemThickness:za,stemColor:ma,whiskerThickness:T,whiskerLength:aa,whiskerColor:M,
lineThickness:O,lineColor:K};c.save();0<za&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=za,c.setLineDash&&c.setLineDash(J(I,za)),c.moveTo(t-F,k),c.lineTo(t-F,h),c.stroke(),c.moveTo(t-F,p),c.lineTo(t-F,n),c.stroke());c.restore();b.lineWidth=Math.max(A,4);c.beginPath();ba(c,v,Math.min(q,k),C,Math.max(k,q),U,0,e,m?z:!1,m?!1:z,!1,!1,qa);c.beginPath();ba(c,v,Math.min(n,q),C,Math.max(q,n),S,0,e,m?!1:z,m?z:!1,!1,!1,qa);c.beginPath();c.lineWidth=A;c.strokeStyle=e;c.rect(v-E,Math.min(k,n)-E,C-v+2*E,Math.max(k,
n)-Math.min(k,n)+2*E);c.stroke();c.save();0<O&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(J(R,O)),c.strokeStyle=K,c.lineWidth=O,c.moveTo(v,q-L),c.lineTo(C,q-L),c.stroke());c.restore();c.save();0<T&&(c.beginPath(),c.setLineDash&&c.setLineDash(J(B,T)),c.strokeStyle=M,c.lineWidth=T,c.moveTo(t-aa/2<<0,p-ha),c.lineTo(t+aa/2<<0,p-ha),c.stroke(),c.moveTo(t-aa/2<<0,h+ha),c.lineTo(t+aa/2<<0,h+ha),c.stroke());c.restore();w&&(e=P(Q),b.strokeStyle=e,b.lineWidth=za,0<za&&(b.moveTo(t-E-F,k),b.lineTo(t-
E-F,Math.max(h,p)),b.stroke(),b.moveTo(t-E-F,Math.min(h,p)),b.lineTo(t-E-F,n),b.stroke()),ba(b,v,Math.max(k,n),C,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<T&&(b.beginPath(),b.lineWidth=T,b.moveTo(t+aa/2,p-ha),b.lineTo(t-aa/2,p-ha),b.stroke(),b.moveTo(t+aa/2,h+ha),b.lineTo(t-aa/2,h+ha),b.stroke()));(x[l].indexLabel||y.indexLabel||x[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:x[l],dataSeries:y,point:{x:v+(C-v)/2,y:a.axisY.reversed?h:p},direction:1,
bounds:{x1:v,y1:Math.min(h,p),x2:C,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,
dest:this.plotArea.ctx,animationCallback:N.fadeInAnimation,easingFunction:N.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
h>a.axisX.dataInfo.viewPortMax)&&!r(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(h);l=a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,fa=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=
t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:fa,y2:t};ba(c,a.axisX.reversed?fa:m,l,a.axisX.reversed?m:fa,t,b,0,b,s,s,!1,!1,q.fillOpacity);b=P(u);w&&ba(this._eventManager.ghostCtx,a.axisX.reversed?fa:m,l,a.axisX.reversed?m:fa,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,
point:{x:m+(fa-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:fa,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(fa-m)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,t),x2:fa,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
...
this.data[u].type.match(/(stacked)/ig)&&A||(this.data[u].type.match(/(range)/ig)&&(f=!0),A++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?fa:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*
this.height,0.9*(this.plotArea.height/(C?fa:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(C?fa:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=
t);if(0<v.length)for(var E=z._colorSet,t=0;t<v.length;t++){var e=z.lineColor=z.options.color?z.options.color:E[0],M={color:v[t].whiskerColor?v[t].whiskerColor:v[t].color?z.whiskerColor?z.whiskerColor:v[t].color:z.whiskerColor?z.whiskerColor:e,thickness:r(v[t].whiskerThickness)?z.whiskerThickness:v[t].whiskerThickness,dashType:v[t].whiskerDashType?v[t].whiskerDashType:z.whiskerDashType,length:r(v[t].whiskerLength)?r(z.options.whiskerLength)?u:z.options.whiskerLength:v[t].whiskerLength,trimLength:r(v[t].whiskerLength)?
r(z.options.whiskerLength)?50:0:0};M.length="number"===typeof M.length?0>=M.length?0:M.length>=u?u:M.length:"string"===typeof M.length?parseInt(M.length)*u/100>u?u:parseInt(M.length)*u/100>u:u;M.thickness="number"===typeof M.thickness?0>M.thickness?0:Math.round(M.thickness):2;var T={color:v[t].stemColor?v[t].stemColor:v[t].color?z.stemColor?z.stemColor:v[t].color:z.stemColor?z.stemColor:e,thickness:v[t].stemThickness?v[t].stemThickness:z.stemThickness,dashType:v[t].stemDashType?v[t].stemDashType:
z.stemDashType};T.thickness="number"===typeof T.thickness?0>T.thickness?0:Math.round(T.thickness):2;v[t].getTime?s=v[t].x.getTime():s=v[t].x;if(!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax)&&!r(v[t].y)&&v[t].y.length&&"number"===typeof v[t].y[0]&&"number"===typeof v[t].y[1]){var ga=a.axisX.convertValueToPixel(s);b?k=ga:h=ga;ga=a.axisY.convertValueToPixel(v[t].y[0]);b?n=ga:q=ga;ga=a.axisY.convertValueToPixel(v[t].y[1]);b?p=ga:g=ga;b?(q=a.axisX.reversed?k+(C?fa:1)*u/2-(C?A-1:0)*
u<<0:k-(C?fa:1)*u/2+(C?A-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(C?fa:1)*u/2-(C?A-1:0)*u<<0:h-(C?fa:1)*u/2+(C?A-1:0)*u<<0,p=a.axisX.reversed?n-u<<0:n+u<<0);!b&&q>g&&(ga=q,q=g,g=ga);b&&n>p&&(ga=n,n=p,p=ga);ga=z.dataPointIds[t];this._eventManager.objectMap[ga]={id:ga,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:t,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:T,whiskerProperties:M};B(c,Math.min(n,p),Math.min(q,g),
Math.max(p,n),Math.max(g,q),e,M,T,b);w&&B(this._eventManager.ghostCtx,n,q,p,g,e,M,T,b);if(v[t].indexLabel||z.indexLabel||v[t].indexLabelFormatter||z.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:v[t],dataSeries:z,indexKeyword:0,point:{x:b?v[t].y[1]>=v[t].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:v[t].y[1]>=v[t].y[0]?g:q},direction:v[t].y[1]>=v[t].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",
dataPoint:v[t],dataSeries:z,indexKeyword:1,point:{x:b?v[t].y[1]>=v[t].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:v[t].y[1]>=v[t].y[0]?q:g},direction:v[t].y[1]>=v[t].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],s=g.dataPoints;if(0<s.length){var m=5<n&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<s.length;f++)if(s[f].getTime?k=s[f].x.getTime():k=s[f].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!r(s[f].y)&&s[f].y.length&&"number"===typeof s[f].y[0]&&"number"===typeof s[f].y[1]){l=a.axisY.convertValueToPixel(s[f].y[0]);t=a.axisY.convertValueToPixel(s[f].y[1]);
h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var v=a.axisX.reversed?h-n<<0:h+n<<0;l>t&&(b=l,l=t,t=b);b=s[f].color?s[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,
x1:l,y1:h,x2:t,y2:v};b=P(b);w&&ba(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,!1,!1,!1,!1);if(s[f].indexLabel||g.indexLabel||s[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:s[f],dataSeries:g,indexKeyword:0,point:{x:s[f].y[1]>=s[f].y[0]?l:t,y:h+(v-h)/2},direction:s[f].y[1]>=s[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:s[f],
dataSeries:g,indexKeyword:1,point:{x:s[f].y[1]>=s[f].y[0]?t:l,y:h+(v-h)/2},direction:s[f].y[1]>=s[f].y[0]?1:-1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(s,r);e.beginPath();e.moveTo(s,r);y={x:s,y:r};h=[];h.push({x:s,y1:r,y2:m})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),
e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=P(f);e.fillStyle=f;var f=[],q=!0,g=0,s,r,m,u,y=null;if(0<p.length){var x=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||x,A=v;b.fillStyle=x;b.strokeStyle=v;b.lineWidth=n.lineThickness;var C="solid";if(b.setLineDash){var E=J(n.nullDataLineDashType,
n.lineThickness),C=n.lineDashType,B=J(C,n.lineThickness);b.setLineDash(B)}for(var M=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!M)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){s=a.axisX.convertValueToPixel(u);r=a.axisY.convertValueToPixel(p[g].y[0]);m=a.axisY.convertValueToPixel(p[g].y[1]);q||M?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||
C===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=B,C=n.nullDataLineDashType,b.setLineDash(E)),b.lineTo(s,r),w&&e.lineTo(s,r),h.push({x:s,y1:r,y2:m})):(b.beginPath(),b.moveTo(s,r),y={x:s,y:r},h=[],h.push({x:s,y1:r,y2:m}),w&&(e.beginPath(),e.moveTo(s,r))),M=q=!1):(b.lineTo(s,r),h.push({x:s,y1:r,y2:m}),w&&e.lineTo(s,r),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:s,y1:r,
y2:m};g<p.length-1&&(A!==(p[g].lineColor||v)||C!==(p[g].lineDashType||n.lineDashType))&&(d(),A=p[g].lineColor||v,h[h.length-1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[g].lineDashType?(C=p[g].lineDashType,h[h.length-1].newLineDashArray=J(C,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(C=n.lineDashType,h[h.length-1].newLineDashArray=B,b.setLineDash(B))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var T=n.getMarkerProperties(g,s,m,b);f.push(T);var ga=P(u);
w&&f.push({x:s,y:m,ctx:e,type:T.type,size:T.size,color:ga,borderColor:ga,borderThickness:T.borderThickness});T=n.getMarkerProperties(g,s,r,b);f.push(T);ga=P(u);w&&f.push({x:s,y:r,ctx:e,type:T.type,size:T.size,color:ga,borderColor:ga,borderThickness:T.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:s,y:r},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?
-1:1,color:x}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:s,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:x})}else M||q||d(),M=!0;d();$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=P(f);e.fillStyle=f;var f=[],p=0,q,g,s,r=[],m=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,x=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var z="solid",A;if(b.setLineDash){var C=J(k.nullDataLineDashType,k.lineThickness),z=k.lineDashType;A=J(z,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():
n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);s=a.axisY.convertValueToPixel(n[p].y[1]);var B=k.dataPointIds[p];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:s};r[r.length]={x:q,y:g};m[m.length]={x:q,y:s};p<n.length-1&&(x!==
(n[p].lineColor||y)||z!==(n[p].lineDashType||k.lineDashType))&&(x=n[p].lineColor||y,r[r.length-1].newStrokeStyle=x,b.setLineDash&&(n[p].lineDashType?(z=n[p].lineDashType,r[r.length-1].newLineDashArray=J(z,k.lineThickness)):(z=k.lineDashType,r[r.length-1].newLineDashArray=A)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var I=k.getMarkerProperties(p,q,g,b);f.push(I);var M=P(B);w&&f.push({x:q,y:g,ctx:e,type:I.type,size:I.size,color:M,borderColor:M,borderThickness:I.borderThickness});
I=k.getMarkerProperties(p,q,s,b);f.push(I);M=P(B);w&&f.push({x:q,y:s,ctx:e,type:I.type,size:I.size,color:M,borderColor:M,borderThickness:I.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,
y:s},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<r.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(r[r.length-1].newLineDashArray=C,z=k.nullDataLineDashType):(d(A,y),r=[],m=[])),g=!0;d(A,y);$.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
...
e=null,f=this.plotArea,l=0,h,r,k,n,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;r=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.width,0.9*(this.plotArea.width/a.plotType.totalDataSeries))<<0;var q=a.axisX.dataInfo.minDiff;isFinite(q)||(q=0.3*Math.abs(a.axisX.range));q=this.options.dataPointWidth?
this.dataPointWidth:0.6*(f.width*(a.axisX.logarithmic?Math.log(q)/Math.log(a.axisX.range):Math.abs(q)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&l>r&&(l=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,r));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&r<l)&&(r=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>r&&(q=r);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var s=a.dataSeriesIndexes[g],m=this.data[s],v=m.dataPoints,e=m._colorSet[0];m.risingColor=m.options.risingColor?m.options.risingColor:e;m.fallingColor=m.options.fallingColor?m.options.fallingColor:"#e40a0a";var u="number"===typeof m.options.lineThickness?Math.round(m.lineThickness):1,y=1===Math.round(u)%
2?-0.5:0;if(0<v.length)for(var x=5<q&&m.bevelEnabled?!0:!1,z=!1,A=null,C=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&m.connectNullData)var E=m.options.nullDataLineDashType||!v[l-1].lineDashType?m.nullDataLineDashType:v[l-1].lineDashType;z=!0}else{h=a.axisX.convertValueToPixel(n);r=0===m.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(m.dataPointEOs[l].cumulativeSum);k=0===m.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(m.dataPointEOs[l].cumulativeSumYStartValue);
h=a.axisX.reversed?h+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:h-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var B=a.axisX.reversed?h-q<<0:h+q<<0;r>k&&(e=r,r=k,k=e);a.axisY.reversed&&(e=r,r=k,k=e);e=m.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:l,x1:h,y1:r,x2:B,y2:k};var M=v[l].color?v[l].color:0<v[l].y?m.risingColor:m.fallingColor;ba(c,a.axisX.reversed?B:h,a.axisY.reversed?k:r,a.axisX.reversed?
h:B,a.axisY.reversed?r:k,M,0,M,x,x,!1,!1,m.fillOpacity);e=P(e);w&&ba(this._eventManager.ghostCtx,a.axisX.reversed?B:h,r,a.axisX.reversed?h:B,k,e,0,null,!1,!1,!1,!1);var T,M=h;T="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?r:k:0<v[l].y?k:r;0<l&&A&&(!z||m.connectNullData)&&(z&&c.setLineDash&&c.setLineDash(J(E,u)),c.beginPath(),c.moveTo(A,C-y),c.lineTo(M,T-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(A,
C-y),b.lineTo(M,T-y),0<u&&b.stroke()));z=!1;A=B;C=0<v[l].y?r:k;M=v[l].lineDashType?v[l].lineDashType:m.options.lineDashType?m.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:m.options.lineColor?m.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(M=J(M,u),c.setLineDash(M));(v[l].indexLabel||m.indexLabel||v[l].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:m,point:{x:h+(B-h)/2,y:0<=v[l].y?r:k},
direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:h,y1:Math.min(r,k),x2:B,y2:Math.max(r,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,
f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:N.fadeInAnimation,easingFunction:N.easing.easeInQuad,animationBase:0}}};var W=function(a,d,c,b,e,f,l,h,r){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!w){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
...
f);if(k.indexLabelFormatter||f.indexLabelFormatter)t={chart:m.options,dataSeries:k,dataPoint:f,total:p.total,percent:p.percent};p=f.indexLabelFormatter?f.indexLabelFormatter(t):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=h;h.center={x:x.x,y:x.y};h.y=f.y;h.radius=C;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;
...
C-d<=B)l=!1;l&&(C-=d);d=0;if("inside"!==k.indexLabelPlacement){w=C*v;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=x.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=x.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=C;h.percentInnerRadius=E}for(var t,r,a=0;a<n.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];r=g[u];var z=0,z=b(t,r)-s;if(0>z){for(var A=r=0,G=0;G<n.length;G++)G!==a&&g[G].hemisphere===h.hemisphere&&(g[G].indexLabelTextBlock.y<h.indexLabelTextBlock.y?r++:
...
x.x)<C&&(u/=Math.abs(Math.sin(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)));var L=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<n.length;k++)if(f=!1,t=g[k],t.indexLabelText){var l=e(k);if(null!==l){var h=g[l];z=0;
z=b(t,h);var q;if(q=0>z){q=t.indexLabelTextBlock.x;var r=t.indexLabelTextBlock.y-t.indexLabelTextBlock.height/2,m=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,s=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,D=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||r>D+p||m<s-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-z),0===k%Math.max(n.length/
...
a.lineTo(Math.round(d.x6),Math.round(d.y6))),a.closePath(),a.fillStyle=b?b:d.color,a.fill(),a.globalAplha=1,a.restore())};m.prototype.renderFunnel=function(a){function d(){for(var a=0,b=[],c=0;c<y.length;c++){if("undefined"===typeof y[c].y)return-1;y[c].y="number"===typeof y[c].y?y[c].y:0;a+=Math.abs(y[c].y)}if(0===a)return-1;for(c=b[0]=0;c<y.length;c++)b.push(Math.abs(y[c].y)*E/a);return b}function c(){var a=X,b=Z,c=L,d=$,e,f;e=O;f=R-P;d=Math.abs((f-e)*(b-a+(d-c))/2);c=$-L;e=f-e;f=c*(f-R);f=Math.abs(f);
f=d+f;for(var d=[],g=0,k=0;k<y.length;k++){if("undefined"===typeof y[k].y)return-1;y[k].y="number"===typeof y[k].y?y[k].y:0;g+=Math.abs(y[k].y)}if(0===g)return-1;for(var l=d[0]=0,h=0,n,p,b=b-a,l=!1,k=0;k<y.length;k++)a=Math.abs(y[k].y)*f/g,l?n=0==Number(c.toFixed(3))?0:a/c:(p=ba*ba*b*b-4*Math.abs(ba)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=0==p?0:a/p,h+=a/p,l=!0):(n=(Math.abs(ba)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs(ba),h+=n,h>e&&(h-=n,p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=a/p,h+=a/p,l=!0),
b=p)),d.push(n);return d}function b(){if(u&&y){for(var a,b,c,d,e,f,k,l,h,n,p,q,t,m,s,D=[],x=[],v={percent:null,total:null},z=null,C=0;C<y.length;C++)s=Q[C],s="undefined"!==typeof s.x5?(s.y2+s.y4)/2:(s.y2+s.y3)/2,s=g(s).x2+1,D[C]=K-s-U;s=0.5*U;for(var C=0,B=y.length-1;C<y.length||0<=B;C++,B--){b=u.reversed?y[B]:y[C];a=b.color?b.color:u.reversed?u._colorSet[(y.length-1-C)%u._colorSet.length]:u._colorSet[C%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";m=b.indexLabelTextAlign||
...
b.indexLabelLineThickness:"number"===typeof u.indexLabelLineThickness?u.indexLabelLineThickness:2;p=b.indexLabelLineDashType||u.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[C];A._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:C,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-C:C]};"inside"===u.indexLabelPlacement&&(D[C]=C!==ca?u.reversed?Q[C].x2-Q[C].x1:
Q[C].x3-Q[C].x4:Q[C].x3-Q[C].x6,20>D[C]&&(D[C]=C!==ca?u.reversed?Q[C].x3-Q[C].x4:Q[C].x2-Q[C].x1:Q[C].x2-Q[C].x1,D[C]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:D[C];if(t>D[C]||0>t)t=D[C];x[C]="inside"===u.indexLabelPlacement?Q[C].height:!1;v=A.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)z={chart:A.options,dataSeries:u,dataPoint:b,total:v.total,percent:v.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(z):b.indexLabel?
A.replaceKeywordsWithValue(b.indexLabel,b,u,C):u.indexLabelFormatter?u.indexLabelFormatter(z):u.indexLabel?A.replaceKeywordsWithValue(u.indexLabel,b,u,C):b.label?b.label:"";0>=n&&(n=0);1E3>t&&1E3-t<s&&(t+=1E3-t);S.roundRect||Ba(S);c=new ka(S,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:t,maxHeight:!1===x[C]?q?4.28571429*f:1.5*f:x[C],text:b,padding:da});c.measureText();H.push({textBlock:c,id:u.reversed?B:C,isDirty:!1,lineColor:a,
lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=K-Z-U/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=H.length-1;0<=l;l--){g=y[H[l].id];c=H[l];d=c.textBlock;b=(a=q(l)<Q.length?H[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=H.length-1;0<=l;l--)a=Q[l],H[l].textBlock.maxWidth=
f[f.length-(l+1)],H[l].textBlock.measureText(),H[l].textBlock.x=K-k,c=H[l].textBlock.height<H[l].textBlock.maxHeight?H[l].textBlock.height:H[l].textBlock.maxHeight,e=H[l].textBlock.width<H[l].textBlock.maxWidth?H[l].textBlock.width:H[l].textBlock.maxWidth,H[l].height=c,H[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,H[l].textBlock.y=c-H[l].height/2,u.reversed?(H[l].textBlock.y+H[l].height>V+z&&(H[l].textBlock.y=V+z-H[l].height),H[l].textBlock.y<qa-z&&(H[l].textBlock.y=qa-z)):
(H[l].textBlock.y<V-z&&(H[l].textBlock.y=V-z),H[l].textBlock.y+H[l].height>qa+z&&(H[l].textBlock.y=qa+z-H[l].height))}function f(){var a,b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=Q[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>Aa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<Aa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,H[e].textBlock.x=b+U,H[e].textBlock.y=
c-H[e].height/2,u.reversed?(H[e].textBlock.y+H[e].height>V+z&&(H[e].textBlock.y=V+z-H[e].height),H[e].textBlock.y<qa-z&&(H[e].textBlock.y=qa-z)):(H[e].textBlock.y<V-z&&(H[e].textBlock.y=V-z),H[e].textBlock.y+H[e].height>qa+z&&(H[e].textBlock.y=qa+z-H[e].height)));else for(e=0;e<Q.length;e++)0==H[e].textBlock.text.length?H[e].isDirty=!0:(a=Q[e],b=a.height,c=H[e].height,d=H[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,H[e].textBlock.x=b,H[e].textBlock.y=
...
H[t].height>e)&&(k=q(t),!(k>=H.length-1)&&H[t].textBlock.y+H[t].height+da>H[k].textBlock.y&&(H[t].textBlock.y=H[t].textBlock.y+H[t].height-e>e-H[t].textBlock.y?e+1:e-H[t].height-1))}for(k=Q.length-1;0<k;k--)if(!H[k].isDirty){e=p(k);if(0>e&&(e=0,H[e].isDirty))break;if(H[k].textBlock.y<H[e].textBlock.y+H[e].height){d=d||k;f=k;for(l=0;H[f].textBlock.y<H[e].textBlock.y+H[e].height+da;){a=a||H[f].textBlock.y+H[f].height;l+=H[f].height;l+=da;f=e;if(0>=f){f=0;l+=H[f].height;break}e=p(f);if(0>e){f=0;l+=H[f].height;
break}}if(f!=k){g=H[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(Q[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=H[b.id].height+da,H[b.id].textBlock.text="",H[b.id].indexLabelText="",H[b.id].isDirty=!0,H[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,n=1,r=0;r<2*n;r++){for(var s=H.length-1;0<=s&&!(0<=p(s)&&p(s),f=H[s],g=f.textBlock,k=(l=q(s)<Q.length?
H[q(s)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+da>+k.y.toFixed(6))&&(d=g.y+d+da-k.y,e=a(s,-d),e<d&&(0<e&&(d-=e),e=a(q(s),d),e!=d)));s--);b()}}function h(a,b){return(b<Q.length?H[b].textBlock.y:u.reversed?V+z:qa+z)-(0>a?u.reversed?qa-z:V-z:H[a].textBlock.y+H[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=z,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=ia;else{e=z*(1!=W.length||
0!=W[0]&&W[0]!=Q.length-1?2:1)/k();for(var t=0;t<Q.length;t++){if(1==W.length&&0==W[0]){if(0===t){l.push(ia[t]);d=h;continue}}else 0===t&&(d=-1*h);l.push(ia[t]+d);if(0<=W.indexOf(t)||t<Q.length&&0<=W.indexOf(t+1))d+=e}}g=function(){for(var a=[],b=0;b<Q.length;b++)a.push(l[b]-Q[b].y1);return a}();var q={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return N.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<Q.length;d++)b=g[d],c=Q[d],b*=a,"undefined"===
typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ja=!0;d.clearRect(x.x1,x.y1,x.x2-x.x1,x.y2-x.y1);d.fillStyle=a.backgroundColor;d.fillRect(x.x1,x.y1,x.width,x.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[y.length-1-b]:u.dataPoints[b];e.index=u.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<Q.length;e++)oa(d,
Q[e],u.fillOpacity);v(d);M&&("inside"!==u.indexLabelPlacement?n(d):f(),s(d));1<=c&&(ja=!1)},null,N.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<Q.length-1;b++)(0<=W.indexOf(b)||0<=W.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<Q.length;f++)e=1===H[f].lineThickness%2?0.5:0,c=((Q[f].y2+Q[f].y4)/2<<0)+e,b=g(c).x2-1,d=H[f].textBlock.x,e=(H[f].textBlock.y+H[f].height/2<<0)+e,H[f].isDirty||0==H[f].lineThickness||(a.strokeStyle=H[f].lineColor,a.lineWidth=H[f].lineThickness,a.setLineDash&&
...
0;b<Q.length;b++)H[b].isDirty||(a&&(H[b].textBlock.ctx=a),H[b].textBlock.render(!0))}function v(a){A.plotArea.layoutManager.reset();a.roundRect||Ba(a);A.title&&(A.title.dockInsidePlotArea||"center"===A.title.horizontalAlign&&"center"===A.title.verticalAlign)&&(A.title.ctx=a,A.title.render());if(A.subtitles)for(var b=0;b<A.subtitles.length;b++){var c=A.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)A.subtitles.ctx=a,c.render()}A.legend&&(A.legend.dockInsidePlotArea||
"center"===A.legend.horizontalAlign&&"center"===A.legend.verticalAlign)&&(A.legend.ctx=a,A.legend.setLayout(),A.legend.render());Ga.fNg&&Ga.fNg(A)}var A=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,x=this.plotArea,z=0.025*x.width,B=0.01*x.width,C=0,E=x.height-2*z,I=Math.min(x.width-2*B,2.8*x.height),M=!1,T=0;T<y.length;T++)if(!M&&("undefined"!==typeof y[T].indexLabel&&null!==y[T].indexLabel&&0<y[T].indexLabel.toString().length)&&(M=!0),!M&&("undefined"!==
typeof y[T].label&&null!==y[T].label&&0<y[T].label.toString().length)&&(M=!0),!M&&"function"===typeof u.indexLabelFormatter||"function"===typeof y[T].indexLabelFormatter)M=!0;M=M||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&M||(B=(x.width-0.75*I)/2);var T=x.x1+B,K=x.x2-B,O=x.y1+z,R=x.y2-z,S=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var P,F;a=75*I/100;var U=30*
(K-a)/100;"funnel"===u.type?(P=r(u.options.neckHeight)?0.35*E:u.neckHeight,F=r(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===typeof P&&P.match(/%$/)?(P=parseInt(P),P=P*E/100):P=parseInt(P),"string"===typeof F&&F.match(/%$/)?(F=parseInt(F),F=F*a/100):F=parseInt(F),P>E?P=E:0>=P&&(P=0),F>a?F=a-0.5:0>=F&&(F=0)):"pyramid"===u.type&&(F=P=0,u.reversed=u.reversed?!1:!0);var B=T+a/2,X=T,Z=T+a,V=u.reversed?R:O,L=B-F/2,$=B+F/2,Aa=u.reversed?O+P:R-P,qa=u.reversed?O:R;a=[];var B=[],Q=[],I=[],Y=O,ca,ba=(Aa-
V)/(L-X),ea=-ba,T="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==T){if(u.reversed)for(I.push(Y),F=T.length-1;0<F;F--)Y+=T[F],I.push(Y);else for(F=0;F<T.length;F++)Y+=T[F],I.push(Y);if(u.reversed)for(F=0;F<T.length;F++)I[F]<Aa?(a.push(L),B.push($),ca=F):(a.push((I[F]-V+ba*X)/ba),B.push((I[F]-V+ea*Z)/ea));else for(F=0;F<T.length;F++)I[F]<Aa?(a.push((I[F]-V+ba*X)/ba),B.push((I[F]-V+ea*Z)/ea),ca=F):(a.push(L),B.push($));for(F=0;F<T.length-1;F++)Y=u.reversed?y[y.length-1-F].color?
y[y.length-1-F].color:u._colorSet[(y.length-1-F)%u._colorSet.length]:y[F].color?y[F].color:u._colorSet[F%u._colorSet.length],F===ca?Q.push({x1:a[F],y1:I[F],x2:B[F],y2:I[F],x3:$,y3:Aa,x4:B[F+1],y4:I[F+1],x5:a[F+1],y5:I[F+1],x6:L,y6:Aa,id:F,height:I[F+1]-I[F],color:Y}):Q.push({x1:a[F],y1:I[F],x2:B[F],y2:I[F],x3:B[F+1],y3:I[F+1],x4:a[F+1],y4:I[F+1],id:F,height:I[F+1]-I[F],color:Y});var da=2,H=[],ja=!1,W=[],ia=[],T=!1;a=a=0;Ca(W);for(F=0;F<y.length;F++)y[F].exploded&&(T=!0,u.reversed?W.push(y.length-
1-F):W.push(F));S.clearRect(x.x1,x.y1,x.width,x.height);S.fillStyle=A.backgroundColor;S.fillRect(x.x1,x.y1,x.width,x.height);if(M&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(F=0;F<y.length;F++)H[F].isDirty||(a=H[F].textBlock.x+H[F].width,a=(K-a)/2,0==F&&(C=a),C>a&&(C=a));for(F=0;F<Q.length;F++)Q[F].x1+=C,Q[F].x2+=C,Q[F].x3+=C,Q[F].x4+=C,Q[F].x5&&(Q[F].x5+=C,Q[F].x6+=C),H[F].textBlock.x+=C}for(F=0;F<Q.length;F++)C=Q[F],oa(S,C,u.fillOpacity),ia.push(C.y1);v(S);M&&u.visible&&
("inside"===u.indexLabelPlacement||A.animationEnabled||n(S),A.animationEnabled||s());if(!M)for(F=0;F<y.length;F++)C=u.dataPointIds[F],a={id:C,objectType:"dataPoint",dataPointIndex:F,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-F:F]},A._eventManager.objectMap[C]=a;!A.animationEnabled&&T?m(A,-1,0):A.animationEnabled&&!A.animatedRender&&m(A,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ja&&!A.isAnimating&&(r(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?
...
dataSeries:p,dataPoint:null}):p.name,s=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?r(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],w=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,v=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,u=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===
p.type&&this.errorMarkerColor.push(s);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:s,text:g,textBlock:null,chartType:p.type,markerSize:w,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};m.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var x=p.dataPoints[y],q=x.legendMarkerType?x.legendMarkerType:p.legendMarkerType?p.legendMarkerType:S.getDefaultLegendMarker(p.type),g=x.legendText?x.legendText:
p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:x}):x.name?x.name:"DataPoint: "+(y+1),s=x.legendMarkerColor?x.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:x.color?x.color:p.color?p.color:p._colorSet[y%p._colorSet.length],w=0.75*this.lineHeight,v=x.legendMarkerBorderColor?x.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:x.markerBorderColor?x.markerBorderColor:p.markerBorderColor,
u=x.legendMarkerBorderThickness?x.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:x.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,x,p,y),q={markerType:q,markerColor:s,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:n,dataPointIndex:y,markerBorderColor:v,markerBorderThickness:u};(x.showInLegend||p.showInLegend&&!1!==x.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();
...
Math.round(q.textBlock.width+w+h+(0===p.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)p={items:[],width:0},k.push(p),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=new ka(this.ctx,{x:0,y:0,maxWidth:x,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
...
q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);s=q.textBlock.width+(w+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=s;this.height=!1===this.itemWrap?k.length*this.lineHeight:this.height+g;this.height=Math.min(l,this.height);this.width=Math.min(f,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-
...
this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var h=0,r=0;r<l.length;r++){for(var k=l[r],n=0,p=0;p<k.items.length;p++){var q=k.items[p],g=q.textBlock.x+a+(0===p?0.2*f:this.horizontalSpacing),s=d+h,m=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||
"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,s+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,s+this.lineHeight/2),this.ctx.stroke(),m-=0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,u=s+0.15*this.lineHeight,v=0.7*this.lineHeight,x=v+
0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+v,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+v/2,u);this.ctx.lineTo(w+v/2,u+x);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,u+x);this.ctx.lineTo(w+v,u+x);this.ctx.stroke();this.errorMarkerColor.shift()}$.drawMarker(g+f/2,s+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);
q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(s+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();n=0<p?Math.max(n,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=P(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(m,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-m,q.textBlock.height);
q.x1=this.chart._eventManager.objectMap[q.id].x1=m;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};na(S,X);S.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===
...
a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var w=la("markerSize",g,this)||4,v=c?20:w,m=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));m<=v&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:m});q=Math.abs(q.x1-a);q<=r?r=q:0<l?k++:n++;m<=w/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":w=la("markerSize",g,this)||
...
0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=f;a.maxHeight=l;var s=a.measureText();m=s.height}e=[];q=p=0;if(this.labelAutoFit||this.options.labelAutoFit)if(r(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360)),"bottom"===this._position||"top"===this._position)if(f=0.9*h>>0,q=0,!this.chart.panEnabled&&1<=
...
l,this.sessionVariables.labelMaxWidth=f,d&&s.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>f?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelWrap=this.labelWrap);else{if(r(this.options.labelWrap))if(!r(this.options.labelMaxWidth))this.options.labelMaxWidth<f?
...
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<E?l+=E:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<E&&(l+=E),0<h&&(m-=h))),n.panEnabled?W=r(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=W:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=W,h=Math.round(f.y2-W-e+F),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+y[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(W+e-y[g]-F),width:m-l,height:k-h}),F+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+Q+L),d[g].lineCoordinates.x2=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?Y=r(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=Y:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=Y,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+Y+X-S,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-x[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(Y+
X-x[g]-S),x2:m,y2:k,width:m-l,height:k-h},S+=x[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)L=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+Y+X<Math.max(L,p)?Math.max(L,p):f.y1+Y+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-W-e-L),c[g].lineCoordinates={x1:l-U,y1:h,x2:m-U,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(z[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(z[g]+U),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=z[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+Y+X<Math.max(L,p)?Math.max(L,p):f.y1+Y+X),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(W+e+L)),b[g].lineCoordinates=
{x1:l+V,y1:h,x2:l+V,y2:k,height:Math.abs(k-h)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(A[g]-(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0))-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:h,x2:m+(A[g]+V),y2:k,width:m-l,height:k-h},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)s=N[w-1][g]===N[w][g]?!0:!1;else s=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)I=O[w-1][g]===O[w][g]?!0:!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=P[w-1][g]===P[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=R[w-
1][g]===R[w][g]?!0:!1;else K=!0}if(s&&I&&J&&K)break;w++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{p=
[];C=[];E=[];v=[];B=[];u=[];N=[];for(O=[];4>w;){W=V=S=U=Z=L=X=e=R=P=F=Y=0;if(a&&0<a.length)for(E=[],g=V=0;g<a.length;g++)E.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=E[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else E.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));N.push(E);if(d&&0<d.length)for(v=[],g=W=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),W+=v[g],X+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));O.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-W-X>n.width-10?n.width-10:f.x2-W-X),c[g].labelAutoFit&&!r(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-x/2:0===c[g].labelAngle?m-x/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-W-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-W-X),b[g]&&b[g].labelAutoFit&&!r(z)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,z):0===b[g].labelAngle?Math.max(l,z/2):l),0<!d.length&&(m-=A/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;m=Math.round(f.x2-W-X);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>n.height-Math.max(L,10)?n.height-Math.max(L,10):f.y2-U):f.y2>n.height-Math.max(L,10)?n.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(m=0>c[L].labelAngle?Math.max(m,y):0===c[L].labelAngle?Math.max(m,y/2):m,l=0>c[L].labelAngle||0===c[L].labelAngle?m-W:l);if(b&&0<b.length)for(L=0;L<b.length;L++)b[L]&&
b[L].labelAutoFit&&(m=b[L].lineCoordinates.x2,l=m-W);d[g].lineCoordinates={x1:m+R,y1:h,x2:m+R,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(v[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:m+v[g]+R,y2:k,width:m-l,height:k-h};d[g].title&&(d[g]._titleTextBlock.maxWidth=
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=v[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)s=N[w-1][g]===N[w][g]?!0:!1;else s=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)I=O[w-1][g]===O[w][g]?!0:
!1;else I=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=B[w-1][g]===B[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=u[w-1][g]===u[w][g]?!0:!1;else K=!0}if(s&&I&&J&&K)break;w++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
(c=!0));this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};Y.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};Y.prototype.render=function(a,d,c){var b,e,f,h,m=null,w=null,k=null,n="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var p=0,p="xySwapped"===this.chart.plotInfo.axisPlacement?
...
for(s=u=0;s<y.dataPoint.y.length;s++)u=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[s])),u<v&&(v=u,b=s);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;this.value=y.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):r(this.options.label)?ea(r(c)?y.dataPoint.y[b]:c,this.valueFormatString,this.chart._cultureInfo):
...
ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[B].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=x=u=0;for(s=B;0<=s;s--)x+=n[s].dataPoint.y,z=n[s].dataPoint.x.getTime?n[s].dataPoint.x.getTime():n[s].dataPoint.x,z=100*(x/n[s].dataSeries.plotUnit.dataPointYSums[z]),u=Math.abs(a-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=s);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:
this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):r(this.options.label)?ea(r(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,
crosshair:this.options,value:y.dataPoint.y}):r(this.options.label)?ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/
...
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ya(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ea(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
...
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ya(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ea(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
...
Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[0]));for(s=u=0;s<y.dataPoint.y.length;s++)u=Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[s])),u<v&&(v=u,b=s);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):r(this.options.label)?ea(r(c)?y.dataPoint.y[b]:c,this.valueFormatString,
...
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):r(this.options.label)?ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x}else if("stackedColumn100"===this.parent.dataSeries[B].type||"stackedArea100"===this.parent.dataSeries[B].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));x=u=0;for(s=B;0<=s;s--)x+=n[s].dataPoint.y,z=n[s].dataPoint.x.getTime?n[s].dataPoint.x.getTime():n[s].dataPoint.x,z=100*(x/n[s].dataSeries.plotUnit.dataPointYSums[z]),
u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=s);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):r(this.options.label)?ea(r(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else"waterfall"===this.parent.dataSeries[B].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataSeries.dataPointEOs[y.index].cumulativeSum}):r(this.options.label)?ea(r(c)?y.dataSeries.dataPointEOs[y.index].cumulativeSum:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataSeries.dataPointEOs[y.index].cumulativeSum):(w=1===q.lineWidth%2?(r(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<
0)+0.5:r(a)?d:this.parent.convertValueToPixel(y.dataPoint.y)<<0,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:r(c)?y.dataPoint.y:c}):r(this.options.label)?ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=y.dataPoint.y);f=h=w;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};k.y=h+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?
...
value:r(c)?this.parent.convertPixelToValue(a):c}):r(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:r(c)?this.parent.convertPixelToValue(d):c}):r(this.options.label)?ya(r(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:r(c)?this.parent.convertPixelToValue(d):c}):r(this.options.label)?ea(r(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label);k.y=d+k.fontSize/2-k.measureText().height/2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?
...
this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:r(c)?this.parent.convertPixelToValue(a):c}):r(this.options.label)?ya(r(c)?this.parent.convertPixelToValue(a):c,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:r(c)?0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):"":c}):r(this.options.label)?
ea(r(c)?this.parent.convertPixelToValue(a):c,this.valueFormatString,this.chart._cultureInfo):this.label);k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position)k.text=
...
v.version="v3.7.5 GA";window.CanvasJS&&(v&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=v)})();
