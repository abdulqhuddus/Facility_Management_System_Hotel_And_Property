...
date_default_timezone_set('Asia/Dubai');
$sql2 = "SELECT sum(amount) as Total  FROM rents";
if (!empty($date)) {
    $date = $_POST['date'];
    $date = explode(" - ", $date);
    // convert dd/mm/yyyy to yyyy-mm-dd
...
<div class="t-head">Rent Payments</div>
<div class="card-body">
    ...
    <table id="example" class="display nowrap" style="width:100%;text-align:center;">
        <thead>
            <tr>
                ...
                <th style="text-align:center !important;">Quarter</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php 
                $total_amount = ($row_transactions['amount'] * 4) + $row_transactions['security'] + $row_transactions['insurance'] + $row_transactions['service_charge'];
                ...
                <td style="text-align: left;">
                    ...
                    <a href="php/download.php?type=Rent&file_id=<?php echo $row_transactions['id'] ?>" style="font-weight:bold;font-weight: bold;background: #337ab7;color: white;padding: 5px;border-radius: 5px;"><i class="fa-solid fa-download"></i> Download</a>
                </td>
                <?php 
