...
?>
<div class="t-head">Al Ihsan Tower 2</div>
<?php
...
<div class="dash-home">
    <table>
    <tr>
            <th style="font-size:30px;"><i class="fa-solid fa-stairs"></i> Ground</th>
            <?php
        $f5 = "SELECT * from apartments WHERE floor='0'";
        ...
        ?>
            ...
            if($result_days < 0){
                ...
                <button type="submit" name="submit" style="background:red;color:white;border:2px solid white;">
                    ...
                    <?php 
                    if($f5_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                    elseif($f5_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
            ...
            ?><form action="apartment.php" method="POST">
                    ...
                    <button type="submit" name="submit" style="background:orange;color:black;border:2px solid white;">
                        ...
                        <?php 
                        if($f5_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f5_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f5_row['bedroom'] === "0"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";} 
                        ?></p>
                    </button>
                </form>
                <?php
            ...
            ?><form action="apartment.php" method="POST">
                    <input type="hidden" name="door" id="door" value="<?php echo $f5_row['door']; ?>">
                    <button type="submit" name="submit" style="background:green;width:100%;height:130px;font-size: 30px;">
        ...
        <tr>
            <th style="font-size:30px;"><i class="fa-solid fa-stairs"></i> Floor 1</th>
            <?php
        ...
        ?>
            ...
            ?><form action="apartment.php" method="POST">
                    ...
                    <button type="submit" name="submit" style="background:red;color:white;border:2px solid white;">
                        ...
                        <?php 
                        if($f1_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                        elseif($f1_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                ...
                ?><form action="apartment.php" method="POST">
                        ...
                        <button type="submit" name="submit" style="background:orange;color:black;border:2px solid white;">
                            ...
                            <?php 
                            if($f1_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                            elseif($f1_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                            elseif($f1_row['bedroom'] === "0"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";} 
                            ?></p>
                        </button>
                    </form>
                    <?php
        ...
        <!--------------->
        <tr>
            <th style="font-size:30px;"><i class="fa-solid fa-stairs"></i> Floor 2</th>
            <?php
        ...
        ?>
            ...
            if($result_days < 0){
                ...
                <button type="submit" name="submit" style="background:red;color:white;border:2px solid white;">
                    ...
                    <?php 
                    if($f2_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                    elseif($f2_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
            ...
            ?><form action="apartment.php" method="POST">
                    ...
                    <button type="submit" name="submit" style="background:orange;color:black;border:2px solid white;">
                        ...
                        <?php 
                        if($f2_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f2_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f2_row['bedroom'] === "0"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";} 
                        ?></p>
                    </button>
                </form>
                <?php
        ...
        <!--------------->
        <tr>
            <th style="font-size:30px;"><i class="fa-solid fa-stairs"></i> Floor 3</th>
            <?php
        ...
        ?>
            ...
            ?><form action="apartment.php" method="POST">
                ...
                <button type="submit" name="submit" style="background:red;color:white;border:2px solid white;">
                    ...
                    <?php 
                    if($f3_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                    elseif($f3_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
            ...
            ?><form action="apartment.php" method="POST">
                    ...
                    <button type="submit" name="submit" style="background:orange;color:black;border:2px solid white;">
                        ...
                        <?php 
                        if($f3_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f3_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f3_row['bedroom'] === "0"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";} 
                        ?></p>
                    </button>
                </form>
                <?php
        ...
        <!--------------->
        <tr>
            <th style="font-size:30px;"><i class="fa-solid fa-stairs"></i> Floor 4</th>
            <?php
        ...
        ?>
            ...
            if($result_days < 0){
                ...
                <button type="submit" name="submit" style="background:red;color:white;border:2px solid white;">
                    ...
                    <?php 
                    if($f4_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
                    elseif($f4_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:white;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:white;font-size:30px'></i>";}
            ...
            ?><form action="apartment.php" method="POST">
                    ...
                    <button type="submit" name="submit" style="background:orange;color:black;border:2px solid white;">
                        ...
                        <?php 
                        if($f4_row['bedroom'] === "1"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f4_row['bedroom'] === "2"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i> <i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";}
                        elseif($f4_row['bedroom'] === "0"){echo "<i class='fa-solid fa-bed' style='color:black;font-size:30px'></i>";} 
                        ?></p>
                    </button>
                </form>
                <?php
