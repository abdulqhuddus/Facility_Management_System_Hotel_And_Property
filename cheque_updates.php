    ...
    <table id="example" class="display nowrap" style="width:100%;text-align:center;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row_transactions['cheque_number']; ?></td>
                <td><?php echo $row_transactions['cheque_date']; ?></td>
                <td><?php echo $row_transactions['cheque_bank']; ?></td>
                <td><a href="attachments/<?php echo $row_transactions['cheque_name']; ?>" target=“blank”  style="font-weight:bold;font-weight: bold;background: #337ab7;color: white;padding: 5px;border-radius: 5px;line-height: 3;"><i class="fa-solid fa-receipt"></i> View</a></td>
