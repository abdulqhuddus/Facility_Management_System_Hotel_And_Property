...
if (isset($_GET['file_id'])) {
    ...
    elseif($_GET['type'] === "Maintenance"){$category = "maintenance_data";}
    ...
    if (file_exists($filepath)) {
        ...
        $updateQuery = "UPDATE $category SET download_count='".$newCount."', date='".$date."', updated_by='".$updated_by."' WHERE id='".$file['id']."'";
