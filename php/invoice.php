...
<h5 class="font-size-15 mb-2"><?php echo $_SESSION['customer_mobile']; ?></h5>
...
<td>
<div>
<h5 class="text-truncate font-size-14 mb-1"><?php echo $_SESSION['type']; ?></h5>
...
<td class="border-0 text-end" style="width: 200px;"><h4 class="m-0 fw-semibold">AED <?php echo $_SESSION['amount']; ?>.00</h4></td>
</tr>
