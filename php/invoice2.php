...
$sql = "SELECT * FROM cancel_contracts WHERE invoice_id='".$_GET['invoice_id']."'";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
$total_amount = ($row['amount'] + $row['service_charge'] + $row['maintenance']) - ($row['refund'] + $row['security']);
?>
...
<td>1</td>
<td class="text-end" style="color:red;">AED -<?php echo $row['security']; ?></td>
</tr>
...
<td>AED <?php echo $row['refund']; ?></td>
<td>1</td>
<td class="text-end" style="color:red;">AED -<?php echo $row['refund']; ?></td>
</tr>
...
<td>
<div>
<p class="text-muted mb-0">Maintenance Charge</p>
</div>
</td>
<td>AED <?php echo $row['maintenance']; ?></td>
<td>1</td>
<td class="text-end">AED <?php echo $row['maintenance']; ?></td>
</tr>
...
<td>
<div>
<p class="text-muted mb-0" style="color:blue;">Rent Balance</p>
