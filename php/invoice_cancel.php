...
<td>1</td>
<td class="text-end" style="color:red;">AED -<?php echo $_SESSION['security']; ?></td>
</tr>
...
<td>AED <?php echo $_SESSION['refund']; ?></td>
<td>1</td>
<td class="text-end" style="color:red;">AED -<?php echo $_SESSION['refund']; ?></td>
</tr>
...
<td>AED <?php echo $_SESSION['maintenance_charge']; ?></td>
<td>1</td>
<td class="text-end">AED <?php echo $_SESSION['maintenance_charge']; ?></td>
</tr>
...
<td>
<div>
<p class="text-muted mb-0" style="color:blue;">Final Charges</p>
...
<td class="text-end">AED <?php echo $_SESSION['total_amount']; ?></td>
</tr>
...
<td class="border-0 text-end" style="width: 200px;"><h4 class="m-0 fw-semibold">AED <?php echo $_SESSION['total_amount']; ?>.00</h4></td>
</tr>
