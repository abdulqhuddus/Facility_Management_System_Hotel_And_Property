...
<td>
<div>
<h5 class="text-truncate font-size-14 mb-1">Tenancy (First Quarter)</h5>
...
<td class="text-end">AED <?php 
$total_amount = $row['amount'] + $row['security'] + $row['insurance'] + $row['service_charge'];
...
<td class="border-0 text-end" style="width: 200px;"><h4 class="m-0 fw-semibold">AED <?php echo $total_amount; ?></h4></td>
</tr>
