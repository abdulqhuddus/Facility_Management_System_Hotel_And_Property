...
$sql = "SELECT * FROM parkings WHERE invoice_id='".$_GET['invoice_id']."'";
...
<div class="row">
    ...
    <p class="mb-1">Apartment: <?php echo $row['parking_number']; ?></p>
...
<td>
<div>
<h5 class="text-truncate font-size-14 mb-1">Parking Contract</h5>
</div>
</td>
