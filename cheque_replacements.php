...
$sql = "SELECT * FROM cheque_replacement";
if (!empty($date)) {
    $date = $_POST['date'];
    $date = explode(" - ", $date);
    ...
    <table id="example" class="display nowrap" style="width:100%;text-align:center;">
        <thead>
            <tr>
                ...
                <th style="text-align:center !important;">New Cheque</th>
                <th style="text-align:center !important;">New Date</th>
                <th style="text-align:center !important;">New Bank</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row_transactions['new_cheque_number']; ?></td>
                <td><?php echo $row_transactions['new_cheque_date']; ?></td>
                <td><?php echo $row_transactions['new_cheque_bank']; ?></td>
                <td><a href="attachments/<?php echo $row_transactions['new_cheque_name']; ?>" target=“blank”  style="font-weight:bold;font-weight: bold;background: #337ab7;color: white;padding: 5px;border-radius: 5px;line-height: 3;"><i class="fa-solid fa-receipt"></i> View</a></td>
